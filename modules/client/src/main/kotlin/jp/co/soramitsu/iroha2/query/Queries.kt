...
object Queries {
    ...
    fun findExecutorDataModel() =
        SingularQueryBox.FindExecutorDataModel(
     ...
     */
    fun findParameters() =
        SingularQueryBox.FindParameters(
            FindParameters(),
        )
}
