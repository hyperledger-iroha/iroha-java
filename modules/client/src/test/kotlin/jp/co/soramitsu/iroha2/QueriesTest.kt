...
//        )
//        QueryBuilder.findAccounts(filter)
//            .account(ALICE_ACCOUNT_ID)
//            .buildSigned(ALICE_KEYPAIR)
//            .let { query ->
//                client.sendQuery(query)
...
//        QueryBuilder.findDomains(filter)
//            .account(ALICE_ACCOUNT_ID)
//            .buildSigned(ALICE_KEYPAIR)
//            .let { query ->
//                client.sendQuery(query)
...
//        }
//
//        QueryBuilder.findTransactions(ALICE_ACCOUNT_ID)
//            .account(ALICE_ACCOUNT_ID)
//            .buildSigned(ALICE_KEYPAIR)
//            .let { query ->
//                client.sendQuery(query)
...
//        val limit = 5L
//        val start = 3L
//        var accounts = QueryBuilder.findAccounts()
//            .account(ALICE_ACCOUNT_ID)
//            .pagination(limit = 5)
//            .buildSigned(ALICE_KEYPAIR)
//            .let { query -> client.sendQuery(query) }
...
//
//        accounts = QueryBuilder.findAccounts()
//            .account(ALICE_ACCOUNT_ID)
...
//        )
//        QueryBuilder.findAssetsDefinitions(filter)
//            .account(ALICE_ACCOUNT_ID)
//            .buildSigned(ALICE_KEYPAIR)
//            .let { query ->
//                client.sendQuery(query)
...
//        val domains = QueryBuilder.findDomains()
//            .account(ALICE_ACCOUNT_ID)
//            .buildSigned(ALICE_KEYPAIR)
//            .let { query -> client.sendQuery(query) }
