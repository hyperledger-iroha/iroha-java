...
public sealed class MintabilityError : ModelEnum {
    ...
    public class MintUnmintable : MintabilityError() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.MintabilityError.MintUnmintable =
                try {
                    MintUnmintable()
                } catch (ex: Exception) {
    ...
    public class ForbidMintOnMintable : MintabilityError() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.MintabilityError.ForbidMintOnMintable =
                try {
    ...
    public companion object : ScaleReader<MintabilityError>, ScaleWriter<MintabilityError> {
        override fun read(reader: ScaleCodecReader): MintabilityError =
