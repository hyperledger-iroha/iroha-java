...
public sealed class TriggerProjectionOfPredicateMarker : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val triggerPredicateAtom: TriggerPredicateAtom) : TriggerProjectionOfPredicateMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.TriggerProjectionOfPredicateMarker.Atom = try {
                Atom(
     ...
     * 'Id' variant
     */
    public data class Id(public val triggerIdProjectionOfPredicateMarker: TriggerIdProjectionOfPredicateMarker) :
        TriggerProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.TriggerProjectionOfPredicateMarker.Id = try {
                Id(
    ...
    public companion object :
        ...
        override fun write(writer: ScaleCodecWriter, instance: TriggerProjectionOfPredicateMarker) {
