...
public sealed class StringPredicateAtom : ModelEnum {
    ...
    public data class Equals(public val string: String) : StringPredicateAtom() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.StringPredicateAtom.Equals = try {
                Equals(
                    reader.readString(),
                )
            } catch (ex: Exception) {
            ...
            override fun write(writer: ScaleCodecWriter, instance: jp.co.soramitsu.iroha2.generated.StringPredicateAtom.Equals): Unit =
                try {
    ...
    public data class Contains(public val string: String) : StringPredicateAtom() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.StringPredicateAtom.Contains = try {
                Contains(
                    reader.readString(),
                )
            } catch (ex: Exception) {
            ...
            override fun write(writer: ScaleCodecWriter, instance: jp.co.soramitsu.iroha2.generated.StringPredicateAtom.Contains): Unit =
                try {
                    writer.writeAsList(instance.string.toByteArray(Charsets.UTF_8))
                } catch (ex: Exception) {
                    throw wrapException(ex)
    ...
    public data class StartsWith(public val string: String) : StringPredicateAtom() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.StringPredicateAtom.StartsWith = try {
                StartsWith(
                    reader.readString(),
                )
            } catch (ex: Exception) {
            ...
            override fun write(writer: ScaleCodecWriter, instance: jp.co.soramitsu.iroha2.generated.StringPredicateAtom.StartsWith): Unit =
                try {
                    writer.writeAsList(instance.string.toByteArray(Charsets.UTF_8))
                } catch (ex: Exception) {
                    throw wrapException(ex)
    ...
    public data class EndsWith(public val string: String) : StringPredicateAtom() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.StringPredicateAtom.EndsWith = try {
                EndsWith(
                    reader.readString(),
                )
            } catch (ex: Exception) {
            ...
            override fun write(writer: ScaleCodecWriter, instance: jp.co.soramitsu.iroha2.generated.StringPredicateAtom.EndsWith): Unit =
                try {
                    writer.writeAsList(instance.string.toByteArray(Charsets.UTF_8))
                } catch (ex: Exception) {
                    throw wrapException(ex)
    ...
    public companion object : ScaleReader<StringPredicateAtom>, ScaleWriter<StringPredicateAtom> {
        override fun read(reader: ScaleCodecReader): StringPredicateAtom = when (val discriminant = reader.readUByte()) {
        ...
        override fun write(writer: ScaleCodecWriter, instance: StringPredicateAtom) {
