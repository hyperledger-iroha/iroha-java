...
public sealed class CompoundPredicateOfPeerId : ModelEnum {
    ...
    public data class Atom(
        public val peerIdProjectionOfPredicateMarker: PeerIdProjectionOfPredicateMarker,
    ) : CompoundPredicateOfPeerId() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfPeerId.Atom =
                try {
                    Atom(
            ...
            override fun write(
                ...
                instance: jp.co.soramitsu.iroha2.generated.CompoundPredicateOfPeerId.Atom,
            ): Unit =
                try {
    ...
    public data class Not(
        public val compoundPredicateOfPeerId: CompoundPredicateOfPeerId,
    ) : CompoundPredicateOfPeerId() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfPeerId.Not =
                try {
                    Not(
            ...
            override fun write(
                writer: ScaleCodecWriter,
                instance: jp.co.soramitsu.iroha2.generated.CompoundPredicateOfPeerId.Not,
            ): Unit =
                try {
    ...
    public data class And(
        public val vec: List<CompoundPredicateOfPeerId>,
    ) : CompoundPredicateOfPeerId() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfPeerId.And =
                try {
                    And(
            ...
            override fun write(
                writer: ScaleCodecWriter,
                instance: jp.co.soramitsu.iroha2.generated.CompoundPredicateOfPeerId.And,
            ): Unit =
                try {
    ...
    public data class Or(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfPeerId.Or =
                try {
                    Or(
                        reader.readVec(reader.readCompactInt()) { CompoundPredicateOfPeerId.read(reader) },
                    )
            ...
            override fun write(
                writer: ScaleCodecWriter,
                instance: jp.co.soramitsu.iroha2.generated.CompoundPredicateOfPeerId.Or,
            ): Unit =
                try {
                    writer.writeCompact(instance.vec.size)
                    instance.vec.forEach { value ->
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): CompoundPredicateOfPeerId =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: CompoundPredicateOfPeerId,
        ) {
