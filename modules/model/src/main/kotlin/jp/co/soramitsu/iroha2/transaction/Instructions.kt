...
class Register {
    companion object {
        ...
        fun account(
            id: AccountId,
            metadata: Metadata = Metadata(mapOf()),
        ) = RegisterOfAccount(NewAccount(id, metadata))
        ...
        ) = RegisterOfAsset(Asset(id, assetValue))
...
class RemoveKeyValue {
    companion object {
        ...
        fun domain(
            domainId: DomainId,
            key: Name,
        ) = RemoveKeyValueOfDomain(domainId, key)
        ...
        fun assetDefinition(
            ...
            key: Name,
        ) = RemoveKeyValueOfAssetDefinition(assetDefinitionId, key)
        ...
        fun account(
            accountId: AccountId,
            key: Name,
        ) = RemoveKeyValueOfAccount(accountId, key)
        ...
        fun asset(
            assetId: AssetId,
            key: Name,
        ) = RemoveKeyValueOfAsset(assetId, key)
        ...
        fun trigger(
            triggerId: TriggerId,
            key: Name,
        ) = RemoveKeyValueOfTrigger(triggerId, key)
    }
}
...
class Mint {
    companion object {
        ...
        fun asset(
            assetId: AssetId,
            quantity: BigDecimal,
        ) = MintOfNumericAndAsset(quantity.asNumeric(), assetId)
        ...
        fun trigger(
            triggerId: TriggerId,
            quantity: Long,
        ) = MintOfu32AndTrigger(quantity, triggerId)
    }
}
...
class Burn {
    companion object {
        ...
        fun asset(
            assetId: AssetId,
            value: BigDecimal,
        ) = BurnOfNumericAndAsset(value.asNumeric(), assetId)
        ...
        fun trigger(
            triggerId: TriggerId,
            quantity: Long,
        ) = BurnOfu32AndTrigger(quantity, triggerId)
    }
}
...
class Grant {
    companion object {
         ...
         */
        fun <P : ModelPermission> accountPermission(
            permission: P,
            destinationId: AccountId,
        ...
        fun accountRole(
            roleId: RoleId,
            destinationId: AccountId,
        ) = GrantOfRoleIdAndAccount(roleId, destinationId)

        /**
         * Grant permission to the given role
         */
        fun <P : ModelPermission> rolePermission(
            permission: P,
            destinationId: RoleId,
...
class Revoke {
    companion object {
        ...
        fun accountRole(
            roleId: RoleId,
            accountId: AccountId,
        ) = RevokeOfRoleIdAndAccount(roleId, accountId)
        ...
        fun <P : ModelPermission> rolePermission(
            permission: P,
            roleId: RoleId,
        ) = RevokeOfPermissionAndRole(permission.asRaw(), roleId)
    }
}
...
class Execute {
    companion object {
         ...
         */
        fun <A : TriggerArgs> trigger(
            triggerId: TriggerId,
            args: A? = null,
        ) = ExecuteTrigger(triggerId, Json.writeValue(args))
    }
}
...
class Multisig {
    fun register(
        accountId: AccountId,
        spec: MultisigSpec,
    ) = MultisigRegister(accountId, spec)
    ...
    fun approve(
        account: AccountId,
        instructionsHash: HashOf<List<InstructionBox>>,
    ) = MultisigApprove(account, instructionsHash)
}
