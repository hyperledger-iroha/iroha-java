...
public sealed class AssetDefinitionProjectionOfPredicateMarker : ModelEnum {
    ...
    public data class Atom(
        public val assetDefinitionPredicateAtom: AssetDefinitionPredicateAtom,
    ) : AssetDefinitionProjectionOfPredicateMarker() {
    ...
    public data class Metadata(
        ...
        public companion object :
            ...
            ): jp.co.soramitsu.iroha2.generated.AssetDefinitionProjectionOfPredicateMarker.Metadata =
                try {
                    Metadata(
    ...
    public companion object :
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: AssetDefinitionProjectionOfPredicateMarker,
        ) {
