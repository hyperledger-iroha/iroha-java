...
public sealed class DomainEvent : ModelEnum {
    ...
    public data class Created(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.DomainEvent.Created =
                try {
                    Created(
                        Domain.read(reader),
                    )
    ...
    public data class Deleted(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.DomainEvent.Deleted =
                try {
                    Deleted(
    ...
    public data class AssetDefinition(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.DomainEvent.AssetDefinition =
                try {
                    AssetDefinition(
    ...
    public data class Account(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.DomainEvent.Account =
                try {
                    Account(
    ...
    public data class MetadataInserted(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.DomainEvent.MetadataInserted =
                try {
                    MetadataInserted(
    ...
    public data class MetadataRemoved(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.DomainEvent.MetadataRemoved =
                try {
                    MetadataRemoved(
                        MetadataChangedOfDomainId.read(reader),
                    )
    ...
    public data class OwnerChanged(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.DomainEvent.OwnerChanged =
                try {
                    OwnerChanged(
    ...
    public companion object : ScaleReader<DomainEvent>, ScaleWriter<DomainEvent> {
        override fun read(reader: ScaleCodecReader): DomainEvent =
