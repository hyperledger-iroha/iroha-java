 ...
 */
public data class MetadataKeyProjectionOfSelectorMarker(
    public val key: Name,
    public val projection: JsonProjectionOfSelectorMarker,
) {
    public companion object :
        ScaleReader<MetadataKeyProjectionOfSelectorMarker>,
        ScaleWriter<MetadataKeyProjectionOfSelectorMarker> {
        override fun read(reader: ScaleCodecReader): MetadataKeyProjectionOfSelectorMarker =
            try {
                MetadataKeyProjectionOfSelectorMarker(
                    Name.read(reader),
        ...
        override fun write(
            ...
            instance: MetadataKeyProjectionOfSelectorMarker,
        ): Unit =
            try {
