 ...
 */
public data class SelectorTupleOfAsset(
    public val vecOfAssetProjectionOfSelectorMarker: List<AssetProjectionOfSelectorMarker>,
) {
    public companion object : ScaleReader<SelectorTupleOfAsset>, ScaleWriter<SelectorTupleOfAsset> {
        override fun read(reader: ScaleCodecReader): SelectorTupleOfAsset =
            try {
                SelectorTupleOfAsset(
