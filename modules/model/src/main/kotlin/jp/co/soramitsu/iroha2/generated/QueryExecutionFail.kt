...
public sealed class QueryExecutionFail : ModelEnum {
    ...
    public data class Find(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.QueryExecutionFail.Find =
                try {
                    Find(
    ...
    public data class Conversion(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.QueryExecutionFail.Conversion =
                try {
                    Conversion(
                        reader.readString(),
                    )
    ...
    public class NotFound : QueryExecutionFail() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.QueryExecutionFail.NotFound =
                try {
                    NotFound()
                } catch (ex: Exception) {
                    throw wrapException(ex)
            ...
            public fun equals(
                o1: jp.co.soramitsu.iroha2.generated.QueryExecutionFail.NotFound,
                o2: Any?,
            ): Boolean =
                when (o2) {
                    null -> false
    ...
    public class CursorMismatch : QueryExecutionFail() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.QueryExecutionFail.CursorMismatch =
                try {
                    CursorMismatch()
                } catch (ex: Exception) {
                    throw wrapException(ex)
    ...
    public class CursorDone : QueryExecutionFail() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.QueryExecutionFail.CursorDone =
                try {
                    CursorDone()
                } catch (ex: Exception) {
                    throw wrapException(ex)
    ...
    public class FetchSizeTooBig : QueryExecutionFail() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.QueryExecutionFail.FetchSizeTooBig =
                try {
                    FetchSizeTooBig()
                } catch (ex: Exception) {
                    throw wrapException(ex)
    ...
    public class CapacityLimit : QueryExecutionFail() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.QueryExecutionFail.CapacityLimit =
                try {
                    CapacityLimit()
                } catch (ex: Exception) {
                    throw wrapException(ex)
    ...
    public companion object : ScaleReader<QueryExecutionFail>, ScaleWriter<QueryExecutionFail> {
        override fun read(reader: ScaleCodecReader): QueryExecutionFail =
