...
public sealed class RemoveKeyValueBox : ModelEnum {
    ...
    public data class Domain(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.RemoveKeyValueBox.Domain =
                try {
                    Domain(
    ...
    public data class Account(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.RemoveKeyValueBox.Account =
                try {
                    Account(
    ...
    public data class AssetDefinition(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.RemoveKeyValueBox.AssetDefinition =
                try {
                    AssetDefinition(
    ...
    public data class Asset(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.RemoveKeyValueBox.Asset =
                try {
                    Asset(
    ...
    public data class Trigger(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.RemoveKeyValueBox.Trigger =
                try {
                    Trigger(
    ...
    public companion object : ScaleReader<RemoveKeyValueBox>, ScaleWriter<RemoveKeyValueBox> {
        override fun read(reader: ScaleCodecReader): RemoveKeyValueBox =
