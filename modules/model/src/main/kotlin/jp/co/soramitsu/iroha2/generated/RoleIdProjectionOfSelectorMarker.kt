...
public sealed class RoleIdProjectionOfSelectorMarker : ModelEnum {
    ...
    public class Atom : RoleIdProjectionOfSelectorMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.RoleIdProjectionOfSelectorMarker.Atom = try {
                Atom()
            } catch (ex: Exception) {
            ...
            public fun equals(o1: jp.co.soramitsu.iroha2.generated.RoleIdProjectionOfSelectorMarker.Atom, o2: Any?): Boolean = when (o2) {
                null -> false
     ...
     * 'Name' variant
     */
    public data class Name(public val nameProjectionOfSelectorMarker: NameProjectionOfSelectorMarker) : RoleIdProjectionOfSelectorMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.RoleIdProjectionOfSelectorMarker.Name = try {
                Name(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): RoleIdProjectionOfSelectorMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            1 -> Name.read(reader)
            else -> throw RuntimeException("Unresolved discriminant of the enum variant: $discriminant")
        }

        override fun write(writer: ScaleCodecWriter, instance: RoleIdProjectionOfSelectorMarker) {
