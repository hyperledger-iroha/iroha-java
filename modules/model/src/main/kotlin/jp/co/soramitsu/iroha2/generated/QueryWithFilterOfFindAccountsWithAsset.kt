...
public data class QueryWithFilterOfFindAccountsWithAsset(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): QueryWithFilterOfFindAccountsWithAsset = try {
            QueryWithFilterOfFindAccountsWithAsset(
        ...
        override fun write(writer: ScaleCodecWriter, instance: QueryWithFilterOfFindAccountsWithAsset): Unit = try {
