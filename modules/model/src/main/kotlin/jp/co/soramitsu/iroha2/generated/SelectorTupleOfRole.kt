 ...
 */
public data class SelectorTupleOfRole(public val vecOfRoleProjectionOfSelectorMarker: List<RoleProjectionOfSelectorMarker>) {
    public companion object : ScaleReader<SelectorTupleOfRole>, ScaleWriter<SelectorTupleOfRole> {
        override fun read(reader: ScaleCodecReader): SelectorTupleOfRole = try {
            SelectorTupleOfRole(
        ...
        override fun write(writer: ScaleCodecWriter, instance: SelectorTupleOfRole): Unit = try {
