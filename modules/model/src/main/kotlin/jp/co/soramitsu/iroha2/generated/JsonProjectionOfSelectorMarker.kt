...
public sealed class JsonProjectionOfSelectorMarker : ModelEnum {
    ...
    public class Atom : JsonProjectionOfSelectorMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.JsonProjectionOfSelectorMarker.Atom =
                try {
                    Atom()
                } catch (ex: Exception) {
            ...
            public fun equals(
                o1: jp.co.soramitsu.iroha2.generated.JsonProjectionOfSelectorMarker.Atom,
                o2: Any?,
            ): Boolean =
                when (o2) {
                    null -> false
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): JsonProjectionOfSelectorMarker =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: JsonProjectionOfSelectorMarker,
        ) {
