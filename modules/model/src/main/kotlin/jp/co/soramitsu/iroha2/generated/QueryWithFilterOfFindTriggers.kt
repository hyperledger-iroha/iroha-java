...
public data class QueryWithFilterOfFindTriggers(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): QueryWithFilterOfFindTriggers = try {
            QueryWithFilterOfFindTriggers(
        ...
        override fun write(writer: ScaleCodecWriter, instance: QueryWithFilterOfFindTriggers): Unit = try {
