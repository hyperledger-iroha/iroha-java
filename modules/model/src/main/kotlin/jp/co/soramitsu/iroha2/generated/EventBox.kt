...
public sealed class EventBox : ModelEnum {
     ...
     * 'Pipeline' variant
     */
    public data class Pipeline(public val pipelineEventBox: PipelineEventBox) : EventBox() {
        ...
        public companion object :
            ...
            override fun write(writer: ScaleCodecWriter, instance: jp.co.soramitsu.iroha2.generated.EventBox.Pipeline): Unit = try {
     ...
     * 'Data' variant
     */
    public data class Data(public val dataEvent: DataEvent) : EventBox() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.EventBox.Data = try {
                Data(
            ...
            override fun write(writer: ScaleCodecWriter, instance: jp.co.soramitsu.iroha2.generated.EventBox.Data): Unit = try {
     ...
     * 'Time' variant
     */
    public data class Time(public val timeEvent: TimeEvent) : EventBox() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.EventBox.Time = try {
                Time(
            ...
            override fun write(writer: ScaleCodecWriter, instance: jp.co.soramitsu.iroha2.generated.EventBox.Time): Unit = try {
     ...
     */
    public data class ExecuteTrigger(public val executeTriggerEvent: ExecuteTriggerEvent) : EventBox() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun write(writer: ScaleCodecWriter, instance: jp.co.soramitsu.iroha2.generated.EventBox.ExecuteTrigger): Unit = try {
     ...
     */
    public data class TriggerCompleted(public val triggerCompletedEvent: TriggerCompletedEvent) : EventBox() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun write(writer: ScaleCodecWriter, instance: jp.co.soramitsu.iroha2.generated.EventBox.TriggerCompleted): Unit = try {
