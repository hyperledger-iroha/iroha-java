...
public sealed class TriggerIdProjectionOfSelectorMarker : ModelEnum {
    ...
    public class Atom : TriggerIdProjectionOfSelectorMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.TriggerIdProjectionOfSelectorMarker.Atom =
                try {
                    Atom()
                } catch (ex: Exception) {
            ...
            public fun equals(
                o1: jp.co.soramitsu.iroha2.generated.TriggerIdProjectionOfSelectorMarker.Atom,
                o2: Any?,
            ): Boolean =
                when (o2) {
                    null -> false
    ...
    public data class Name(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.TriggerIdProjectionOfSelectorMarker.Name =
                try {
                    Name(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): TriggerIdProjectionOfSelectorMarker =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: TriggerIdProjectionOfSelectorMarker,
        ) {
