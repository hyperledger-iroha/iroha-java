...
public sealed class CompoundPredicateOfAssetPredicateBox : ModelEnum {
    ...
    public data class Not(public val compoundPredicateOfAssetPredicateBox: CompoundPredicateOfAssetPredicateBox) :
        ...
        public companion object :
            ...
            override fun write(
                ...
                CompoundPredicateOfAssetPredicateBox.write(writer, instance.compoundPredicateOfAssetPredicateBox)
            } catch (ex: Exception) {
                throw wrapException(ex)
            }
        }
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): CompoundPredicateOfAssetPredicateBox = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            1 -> Not.read(reader)
            2 -> And.read(reader)
            3 -> Or.read(reader)
