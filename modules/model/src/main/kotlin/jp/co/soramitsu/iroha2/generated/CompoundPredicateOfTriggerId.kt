...
public sealed class CompoundPredicateOfTriggerId : ModelEnum {
    ...
    public data class Atom(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfTriggerId.Atom =
                try {
                    Atom(
    ...
    public data class Not(
        public val compoundPredicateOfTriggerId: CompoundPredicateOfTriggerId,
    ) : CompoundPredicateOfTriggerId() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfTriggerId.Not =
                try {
                    Not(
    ...
    public data class And(
        public val vec: List<CompoundPredicateOfTriggerId>,
    ) : CompoundPredicateOfTriggerId() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfTriggerId.And =
                try {
                    And(
    ...
    public data class Or(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfTriggerId.Or =
                try {
                    Or(
                        reader.readVec(reader.readCompactInt()) { CompoundPredicateOfTriggerId.read(reader) },
                    )
            ...
            override fun write(
                writer: ScaleCodecWriter,
                instance: jp.co.soramitsu.iroha2.generated.CompoundPredicateOfTriggerId.Or,
            ): Unit =
                try {
                    writer.writeCompact(instance.vec.size)
                    instance.vec.forEach { value ->
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): CompoundPredicateOfTriggerId =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: CompoundPredicateOfTriggerId,
        ) {
