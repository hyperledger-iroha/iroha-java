...
public sealed class PeerIdProjectionOfSelectorMarker : ModelEnum {
    ...
    public class Atom : PeerIdProjectionOfSelectorMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.PeerIdProjectionOfSelectorMarker.Atom =
                try {
                    Atom()
                } catch (ex: Exception) {
            ...
            public fun equals(
                o1: jp.co.soramitsu.iroha2.generated.PeerIdProjectionOfSelectorMarker.Atom,
                o2: Any?,
            ): Boolean =
                when (o2) {
                    null -> false
    ...
    public data class PublicKey(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.PeerIdProjectionOfSelectorMarker.PublicKey =
                try {
                    PublicKey(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): PeerIdProjectionOfSelectorMarker =
