...
public sealed class MultisigInstructionBox : ModelEnum {
    ...
    public data class Register(public val multisigRegister: MultisigRegister) : MultisigInstructionBox() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.MultisigInstructionBox.Register = try {
                Register(
    ...
    public data class Propose(public val multisigPropose: MultisigPropose) : MultisigInstructionBox() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.MultisigInstructionBox.Propose = try {
                Propose(
    ...
    public data class Approve(public val multisigApprove: MultisigApprove) : MultisigInstructionBox() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.MultisigInstructionBox.Approve = try {
                Approve(
