 ...
 */
public data class SelectorTupleOfPeerId(
    public val vecOfPeerIdProjectionOfSelectorMarker: List<PeerIdProjectionOfSelectorMarker>,
) {
    public companion object : ScaleReader<SelectorTupleOfPeerId>, ScaleWriter<SelectorTupleOfPeerId> {
        override fun read(reader: ScaleCodecReader): SelectorTupleOfPeerId =
            try {
                SelectorTupleOfPeerId(
        ...
        override fun write(
            ...
            instance: SelectorTupleOfPeerId,
        ): Unit =
            try {
