...
public sealed class NameProjectionOfSelectorMarker : ModelEnum {
    ...
    public class Atom : NameProjectionOfSelectorMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.NameProjectionOfSelectorMarker.Atom = try {
                Atom()
            } catch (ex: Exception) {
            ...
            public fun equals(o1: jp.co.soramitsu.iroha2.generated.NameProjectionOfSelectorMarker.Atom, o2: Any?): Boolean = when (o2) {
                null -> false
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): NameProjectionOfSelectorMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            else -> throw RuntimeException("Unresolved discriminant of the enum variant: $discriminant")
        }

        override fun write(writer: ScaleCodecWriter, instance: NameProjectionOfSelectorMarker) {
