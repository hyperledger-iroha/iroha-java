...
public sealed class NameProjectionOfPredicateMarker : ModelEnum {
    ...
    public data class Atom(
        public val stringPredicateAtom: StringPredicateAtom,
    ) : NameProjectionOfPredicateMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.NameProjectionOfPredicateMarker.Atom =
                try {
                    Atom(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): NameProjectionOfPredicateMarker =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: NameProjectionOfPredicateMarker,
        ) {
