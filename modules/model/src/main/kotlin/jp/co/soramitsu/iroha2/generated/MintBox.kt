...
public sealed class MintBox : ModelEnum {
    ...
    public data class TriggerRepetitions(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.MintBox.TriggerRepetitions =
                try {
                    TriggerRepetitions(
    ...
    public companion object : ScaleReader<MintBox>, ScaleWriter<MintBox> {
        override fun read(reader: ScaleCodecReader): MintBox =
