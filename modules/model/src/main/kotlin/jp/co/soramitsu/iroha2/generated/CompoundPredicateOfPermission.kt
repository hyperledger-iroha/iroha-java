...
public sealed class CompoundPredicateOfPermission : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val permissionProjectionOfPredicateMarker: PermissionProjectionOfPredicateMarker) :
        CompoundPredicateOfPermission() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfPermission.Atom = try {
                Atom(
     ...
     * 'Not' variant
     */
    public data class Not(public val compoundPredicateOfPermission: CompoundPredicateOfPermission) : CompoundPredicateOfPermission() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfPermission.Not = try {
                Not(
     ...
     * 'And' variant
     */
    public data class And(public val vec: List<CompoundPredicateOfPermission>) : CompoundPredicateOfPermission() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfPermission.And = try {
                And(
     ...
     * 'Or' variant
     */
    public data class Or(public val vec: List<CompoundPredicateOfPermission>) : CompoundPredicateOfPermission() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfPermission.Or = try {
                Or(
                    reader.readVec(reader.readCompactInt()) { CompoundPredicateOfPermission.read(reader) },
                )
            } catch (ex: Exception) {
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): CompoundPredicateOfPermission = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            1 -> Not.read(reader)
            2 -> And.read(reader)
            3 -> Or.read(reader)
        ...
        override fun write(writer: ScaleCodecWriter, instance: CompoundPredicateOfPermission) {
