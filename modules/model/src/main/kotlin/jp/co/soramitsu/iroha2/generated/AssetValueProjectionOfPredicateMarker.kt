...
public sealed class AssetValueProjectionOfPredicateMarker : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val assetValuePredicateAtom: AssetValuePredicateAtom) : AssetValueProjectionOfPredicateMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AssetValueProjectionOfPredicateMarker.Atom = try {
                Atom(
     ...
     * 'Numeric' variant
     */
    public data class Numeric(public val numericProjectionOfPredicateMarker: NumericProjectionOfPredicateMarker) :
        AssetValueProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
     ...
     * 'Store' variant
     */
    public data class Store(public val metadataProjectionOfPredicateMarker: MetadataProjectionOfPredicateMarker) :
        AssetValueProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): AssetValueProjectionOfPredicateMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
        ...
        override fun write(writer: ScaleCodecWriter, instance: AssetValueProjectionOfPredicateMarker) {
