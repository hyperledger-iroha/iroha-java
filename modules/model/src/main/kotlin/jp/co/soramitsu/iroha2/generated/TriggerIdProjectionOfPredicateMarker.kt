...
public sealed class TriggerIdProjectionOfPredicateMarker : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val triggerIdPredicateAtom: TriggerIdPredicateAtom) : TriggerIdProjectionOfPredicateMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.TriggerIdProjectionOfPredicateMarker.Atom = try {
                Atom(
    ...
    public data class Name(public val nameProjectionOfPredicateMarker: NameProjectionOfPredicateMarker) :
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.TriggerIdProjectionOfPredicateMarker.Name = try {
                Name(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): TriggerIdProjectionOfPredicateMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            1 -> Name.read(reader)
            else -> throw RuntimeException("Unresolved discriminant of the enum variant: $discriminant")
        }

        override fun write(writer: ScaleCodecWriter, instance: TriggerIdProjectionOfPredicateMarker) {
