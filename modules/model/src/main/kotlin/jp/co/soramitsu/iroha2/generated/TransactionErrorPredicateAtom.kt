...
public sealed class TransactionErrorPredicateAtom : ModelEnum {
    ...
    public class IsSome : TransactionErrorPredicateAtom() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.TransactionErrorPredicateAtom.IsSome = try {
                IsSome()
            } catch (ex: Exception) {
            ...
            public fun equals(o1: jp.co.soramitsu.iroha2.generated.TransactionErrorPredicateAtom.IsSome, o2: Any?): Boolean = when (o2) {
                null -> false
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): TransactionErrorPredicateAtom = when (val discriminant = reader.readUByte()) {
            0 -> IsSome.read(reader)
            else -> throw RuntimeException("Unresolved discriminant of the enum variant: $discriminant")
        }

        override fun write(writer: ScaleCodecWriter, instance: TransactionErrorPredicateAtom) {
