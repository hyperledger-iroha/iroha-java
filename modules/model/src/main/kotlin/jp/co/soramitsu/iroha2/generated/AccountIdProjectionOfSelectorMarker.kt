...
public sealed class AccountIdProjectionOfSelectorMarker : ModelEnum {
    ...
    public class Atom : AccountIdProjectionOfSelectorMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AccountIdProjectionOfSelectorMarker.Atom = try {
                Atom()
            } catch (ex: Exception) {
            ...
            public fun equals(o1: jp.co.soramitsu.iroha2.generated.AccountIdProjectionOfSelectorMarker.Atom, o2: Any?): Boolean =
                when (o2) {
                    null -> false
    ...
    public data class Domain(public val domainIdProjectionOfSelectorMarker: DomainIdProjectionOfSelectorMarker) :
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AccountIdProjectionOfSelectorMarker.Domain = try {
                Domain(
     ...
     * 'Signatory' variant
     */
    public data class Signatory(public val publicKeyProjectionOfSelectorMarker: PublicKeyProjectionOfSelectorMarker) :
        AccountIdProjectionOfSelectorMarker() {
        override fun discriminant(): Int = DISCRIMINANT
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): AccountIdProjectionOfSelectorMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
        ...
        override fun write(writer: ScaleCodecWriter, instance: AccountIdProjectionOfSelectorMarker) {
