...
public sealed class AssetDefinitionProjectionOfSelectorMarker : ModelEnum {
    ...
    public class Atom : AssetDefinitionProjectionOfSelectorMarker() {
        ...
        public companion object :
            ...
            public fun equals(o1: jp.co.soramitsu.iroha2.generated.AssetDefinitionProjectionOfSelectorMarker.Atom, o2: Any?): Boolean =
                when (o2) {
                    null -> false
     ...
     * 'Id' variant
     */
    public data class Id(public val assetDefinitionIdProjectionOfSelectorMarker: AssetDefinitionIdProjectionOfSelectorMarker) :
        AssetDefinitionProjectionOfSelectorMarker() {
        override fun discriminant(): Int = DISCRIMINANT
    ...
    public data class Metadata(public val metadataProjectionOfSelectorMarker: MetadataProjectionOfSelectorMarker) :
        ...
        public companion object :
            ...
            ): jp.co.soramitsu.iroha2.generated.AssetDefinitionProjectionOfSelectorMarker.Metadata = try {
                Metadata(
    ...
    public companion object :
        ...
        override fun write(writer: ScaleCodecWriter, instance: AssetDefinitionProjectionOfSelectorMarker) {
