...
public sealed class TransactionHashPredicateAtom : ModelEnum {
    ...
    public data class Equals(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.TransactionHashPredicateAtom.Equals =
                try {
                    Equals(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): TransactionHashPredicateAtom =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: TransactionHashPredicateAtom,
        ) {
