...
public sealed class SignedBlockPredicateAtom : ModelEnum {
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): SignedBlockPredicateAtom = when (val discriminant = reader.readUByte()) {
            else -> throw RuntimeException("Unresolved discriminant of the enum variant: $discriminant")
        }

        override fun write(writer: ScaleCodecWriter, instance: SignedBlockPredicateAtom) {
