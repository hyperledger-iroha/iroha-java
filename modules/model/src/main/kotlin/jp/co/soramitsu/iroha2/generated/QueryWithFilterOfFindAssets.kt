...
public data class QueryWithFilterOfFindAssets(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): QueryWithFilterOfFindAssets = try {
            QueryWithFilterOfFindAssets(
        ...
        override fun write(writer: ScaleCodecWriter, instance: QueryWithFilterOfFindAssets): Unit = try {
