...
public data class QueryWithFilterOfFindAssetsDefinitions(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): QueryWithFilterOfFindAssetsDefinitions = try {
            QueryWithFilterOfFindAssetsDefinitions(
        ...
        override fun write(writer: ScaleCodecWriter, instance: QueryWithFilterOfFindAssetsDefinitions): Unit = try {
