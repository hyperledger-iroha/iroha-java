...
public sealed class AssetPredicateAtom : ModelEnum {
    ...
    public companion object : ScaleReader<AssetPredicateAtom>, ScaleWriter<AssetPredicateAtom> {
        override fun read(reader: ScaleCodecReader): AssetPredicateAtom = when (val discriminant = reader.readUByte()) {
            else -> throw RuntimeException("Unresolved discriminant of the enum variant: $discriminant")
        }

        override fun write(writer: ScaleCodecWriter, instance: AssetPredicateAtom) {
