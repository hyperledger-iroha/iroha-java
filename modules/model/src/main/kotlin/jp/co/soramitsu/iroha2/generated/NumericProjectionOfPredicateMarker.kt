...
public sealed class NumericProjectionOfPredicateMarker : ModelEnum {
    ...
    public data class Atom(
        public val numericPredicateAtom: NumericPredicateAtom,
    ) : NumericProjectionOfPredicateMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.NumericProjectionOfPredicateMarker.Atom =
                try {
                    Atom(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): NumericProjectionOfPredicateMarker =
