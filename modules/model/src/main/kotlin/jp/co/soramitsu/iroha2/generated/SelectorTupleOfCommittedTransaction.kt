...
public data class SelectorTupleOfCommittedTransaction(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): SelectorTupleOfCommittedTransaction = try {
            SelectorTupleOfCommittedTransaction(
        ...
        override fun write(writer: ScaleCodecWriter, instance: SelectorTupleOfCommittedTransaction): Unit = try {
