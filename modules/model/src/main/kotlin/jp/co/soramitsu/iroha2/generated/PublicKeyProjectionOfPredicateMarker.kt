...
public sealed class PublicKeyProjectionOfPredicateMarker : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val publicKeyPredicateAtom: PublicKeyPredicateAtom) : PublicKeyProjectionOfPredicateMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.PublicKeyProjectionOfPredicateMarker.Atom = try {
                Atom(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): PublicKeyProjectionOfPredicateMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            else -> throw RuntimeException("Unresolved discriminant of the enum variant: $discriminant")
        }

        override fun write(writer: ScaleCodecWriter, instance: PublicKeyProjectionOfPredicateMarker) {
