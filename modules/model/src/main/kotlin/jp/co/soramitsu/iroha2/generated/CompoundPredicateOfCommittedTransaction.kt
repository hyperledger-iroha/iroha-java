...
public sealed class CompoundPredicateOfCommittedTransaction : ModelEnum {
    ...
    public data class Atom(
        public val committedTransactionProjectionOfPredicateMarker: CommittedTransactionProjectionOfPredicateMarker,
    ) : CompoundPredicateOfCommittedTransaction() {
    ...
    public data class Not(
        public val compoundPredicateOfCommittedTransaction: CompoundPredicateOfCommittedTransaction,
    ) : CompoundPredicateOfCommittedTransaction() {
        override fun discriminant(): Int = DISCRIMINANT
    ...
    public data class And(
        public val vec: List<CompoundPredicateOfCommittedTransaction>,
    ) : CompoundPredicateOfCommittedTransaction() {
        override fun discriminant(): Int = DISCRIMINANT
    ...
    public data class Or(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfCommittedTransaction.Or =
                try {
                    Or(
                        reader.readVec(reader.readCompactInt()) { CompoundPredicateOfCommittedTransaction.read(reader) },
                    )
    ...
    public companion object :
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: CompoundPredicateOfCommittedTransaction,
        ) {
