...
public sealed class AssetProjectionOfPredicateMarker : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val assetPredicateAtom: AssetPredicateAtom) : AssetProjectionOfPredicateMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AssetProjectionOfPredicateMarker.Atom = try {
                Atom(
     ...
     * 'Id' variant
     */
    public data class Id(public val assetIdProjectionOfPredicateMarker: AssetIdProjectionOfPredicateMarker) :
        AssetProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AssetProjectionOfPredicateMarker.Id = try {
                Id(
     ...
     * 'Value' variant
     */
    public data class Value(public val assetValueProjectionOfPredicateMarker: AssetValueProjectionOfPredicateMarker) :
        AssetProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AssetProjectionOfPredicateMarker.Value = try {
                Value(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): AssetProjectionOfPredicateMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            1 -> Id.read(reader)
            2 -> Value.read(reader)
        ...
        override fun write(writer: ScaleCodecWriter, instance: AssetProjectionOfPredicateMarker) {
