...
public sealed class RoleIdPredicateAtom : ModelEnum {
    ...
    public data class Equals(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.RoleIdPredicateAtom.Equals =
                try {
                    Equals(
                        RoleId.read(reader),
                    )
            ...
            override fun write(
                ...
                instance: jp.co.soramitsu.iroha2.generated.RoleIdPredicateAtom.Equals,
            ): Unit =
                try {
    ...
    public companion object : ScaleReader<RoleIdPredicateAtom>, ScaleWriter<RoleIdPredicateAtom> {
        override fun read(reader: ScaleCodecReader): RoleIdPredicateAtom =
