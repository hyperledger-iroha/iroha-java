...
public sealed class DomainProjectionOfSelectorMarker : ModelEnum {
    ...
    public class Atom : DomainProjectionOfSelectorMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.DomainProjectionOfSelectorMarker.Atom =
                try {
                    Atom()
                } catch (ex: Exception) {
            ...
            public fun equals(
                o1: jp.co.soramitsu.iroha2.generated.DomainProjectionOfSelectorMarker.Atom,
                o2: Any?,
            ): Boolean =
                when (o2) {
                    null -> false
    ...
    public data class Id(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.DomainProjectionOfSelectorMarker.Id =
                try {
                    Id(
    ...
    public data class Metadata(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.DomainProjectionOfSelectorMarker.Metadata =
                try {
                    Metadata(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): DomainProjectionOfSelectorMarker =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: DomainProjectionOfSelectorMarker,
        ) {
