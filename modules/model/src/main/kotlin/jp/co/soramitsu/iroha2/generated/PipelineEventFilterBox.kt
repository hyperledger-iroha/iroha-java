...
public sealed class PipelineEventFilterBox : ModelEnum {
    ...
    public data class Transaction(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.PipelineEventFilterBox.Transaction =
                try {
                    Transaction(
    ...
    public data class Block(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.PipelineEventFilterBox.Block =
                try {
                    Block(
    ...
    public companion object :
        ScaleReader<PipelineEventFilterBox>,
        ScaleWriter<PipelineEventFilterBox> {
        override fun read(reader: ScaleCodecReader): PipelineEventFilterBox =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: PipelineEventFilterBox,
        ) {
