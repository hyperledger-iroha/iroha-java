...
object InstructionDeserializer : JsonDeserializer<InstructionBox>() {
    ...
    ): InstructionBox = deserializeInstruction(p.readValueAsTree(), JSON_SERDE)
...
object IdBoxDeserializer : JsonDeserializer<IdBox>() {
    override fun deserialize(
        p: JsonParser,
        ctxt: DeserializationContext,
    ): IdBox = sealedDeserializeIdBox(p, JSON_SERDE)
}
...
object MetadataDeserializer : JsonDeserializer<Metadata>() {
    override fun deserialize(
        p: JsonParser,
        ctxt: DeserializationContext,
    ): Metadata = deserializeMetadata(p, JSON_SERDE)

    private fun deserializeMetadata(
        p: JsonParser,
        mapper: ObjectMapper,
    ): Metadata {
...
object AssetTypeDeserializer : JsonDeserializer<AssetType>() {
    override fun deserialize(
        ...
        when (p.readValueAsTree<TextNode>().textValue()) {
...
object NumericSpecDeserializer : JsonDeserializer<NumericSpec>() {
    override fun deserialize(
        p: JsonParser,
        ctxt: DeserializationContext,
    ): NumericSpec = NumericSpec(p.readValueAsTree<LongNode>().longValue())
}
...
object NumericDeserializer : JsonDeserializer<Numeric>() {
    override fun deserialize(
        p: JsonParser,
        ctxt: DeserializationContext,
    ): Numeric = p.readValueAs(String::class.java).asNumeric()
}
...
object ChainIdDeserializer : JsonDeserializer<ChainId>() {
    override fun deserialize(
        p: JsonParser,
        ctxt: DeserializationContext,
    ): ChainId = ChainId(p.readValueAs(String::class.java))
}
...
object IpfsPathDeserializer : JsonDeserializer<IpfsPath>() {
    override fun deserialize(
        p: JsonParser,
        ctxt: DeserializationContext,
    ): IpfsPath = IpfsPath(p.readValueAs(String::class.java))
}
...
object RepeatsDeserializer : JsonDeserializer<Repeats>() {
    override fun deserialize(
        ...
        when (val node = p.readValueAsTree<JsonNode>()) {
...
object NameDeserializer : JsonDeserializer<Name>() {
    override fun deserialize(
        p: JsonParser,
        ctxt: DeserializationContext,
    ): Name = Name(p.readValueAs(String::class.java))
}
...
object MintableDeserializer : JsonDeserializer<Mintable>() {
    override fun deserialize(
        ...
        when (val value = p.readValueAs(String::class.java)) {
...
object AssetIdDeserializer : JsonDeserializer<AssetId>() {
    override fun deserialize(
        p: JsonParser,
        ctxt: DeserializationContext,
    ): AssetId = p.readValueAs(String::class.java).asAssetId()
}
...
object AssetDefinitionIdDeserializer : JsonDeserializer<AssetDefinitionId>() {
    override fun deserialize(
        p: JsonParser,
        ctxt: DeserializationContext,
    ): AssetDefinitionId = p.readValueAs(String::class.java).asAssetDefinitionId()
}
...
object AccountIdDeserializer : JsonDeserializer<AccountId>() {
    override fun deserialize(
        p: JsonParser,
        ctxt: DeserializationContext,
    ): AccountId = p.readValueAs(String::class.java).asAccountId()
}
...
object RoleIdDeserializer : JsonDeserializer<RoleId>() {
    override fun deserialize(
        p: JsonParser,
        ctxt: DeserializationContext,
    ): RoleId = p.readValueAs(String::class.java).asRoleId()
}
...
object DomainIdDeserializer : JsonDeserializer<DomainId>() {
    override fun deserialize(
        p: JsonParser,
        ctxt: DeserializationContext,
    ): DomainId = p.readValueAs(String::class.java).asDomainId()
}
...
object AssetDefinitionIdKeyDeserializer : KeyDeserializer() {
    override fun deserializeKey(
        key: String?,
        ctxt: DeserializationContext?,
    ): AssetDefinitionId? = JSON_SERDE.readValue(key, AssetDefinitionId::class.java)
}
...
object AccountIdKeyDeserializer : KeyDeserializer() {
    override fun deserializeKey(
        key: String?,
        ctxt: DeserializationContext?,
    ): AccountId? = JSON_SERDE.readValue(key, AccountId::class.java)
}
...
object AssetIdKeyDeserializer : KeyDeserializer() {
    override fun deserializeKey(
        key: String,
        ctxt: DeserializationContext?,
    ): AssetId? = JSON_SERDE.readValue(key, AssetId::class.java)
}
...
object DomainIdKeyDeserializer : KeyDeserializer() {
    override fun deserializeKey(
        key: String,
        ctxt: DeserializationContext?,
    ): DomainId? = JSON_SERDE.readValue(key, DomainId::class.java)
}
...
object CustomParameterIdKeyDeserializer : KeyDeserializer() {
    override fun deserializeKey(
        key: String,
        ctxt: DeserializationContext?,
    ): CustomParameterId? = JSON_SERDE.readValue(key, CustomParameterId::class.java)
}
// ==================================================
...
object NonZeroOfu64Deserializer : JsonDeserializer<NonZeroOfu64>() {
    override fun deserialize(
        p: JsonParser,
        ctxt: DeserializationContext,
    ): NonZeroOfu64 = NonZeroOfu64(p.readValueAs(BigInteger::class.java))
}
...
private inline fun <reified B> B.serializeBox(gen: JsonGenerator) =
    when (B::class) {
 ...
 */
private fun serializeSingleMember(
    gen: JsonGenerator,
    value: Any,
) {
...
private fun sealedDeserializeIdBox(
    p: JsonParser,
    mapper: ObjectMapper,
): IdBox {
    val node = p.readValueAsTree<JsonNode>().fields().next()
    ...
    val subtype =
        IdBox::class.nestedClasses.find { clazz ->
            !clazz.isCompanion && clazz.simpleName == param
        } ?: throw DeserializationException("Class with constructor($param) not found")
