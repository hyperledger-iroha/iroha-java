...
public sealed class PermissionProjectionOfPredicateMarker : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val permissionPredicateAtom: PermissionPredicateAtom) : PermissionProjectionOfPredicateMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.PermissionProjectionOfPredicateMarker.Atom = try {
                Atom(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): PermissionProjectionOfPredicateMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            else -> throw RuntimeException("Unresolved discriminant of the enum variant: $discriminant")
        }

        override fun write(writer: ScaleCodecWriter, instance: PermissionProjectionOfPredicateMarker) {
