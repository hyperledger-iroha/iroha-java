...
public sealed class AssetDefinitionIdProjectionOfPredicateMarker : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val assetDefinitionIdPredicateAtom: AssetDefinitionIdPredicateAtom) :
        AssetDefinitionIdProjectionOfPredicateMarker() {
        ...
        public companion object :
            ...
            ): jp.co.soramitsu.iroha2.generated.AssetDefinitionIdProjectionOfPredicateMarker.Atom = try {
                Atom(
    ...
    public data class Domain(public val domainIdProjectionOfPredicateMarker: DomainIdProjectionOfPredicateMarker) :
        ...
        public companion object :
            ...
            override fun read(
                reader: ScaleCodecReader,
            ): jp.co.soramitsu.iroha2.generated.AssetDefinitionIdProjectionOfPredicateMarker.Domain = try {
                Domain(
    ...
    public data class Name(public val nameProjectionOfPredicateMarker: NameProjectionOfPredicateMarker) :
        ...
        public companion object :
            ...
            override fun read(
                reader: ScaleCodecReader,
            ): jp.co.soramitsu.iroha2.generated.AssetDefinitionIdProjectionOfPredicateMarker.Name = try {
                Name(
    ...
    public companion object :
        ...
        override fun write(writer: ScaleCodecWriter, instance: AssetDefinitionIdProjectionOfPredicateMarker) {
