...
public sealed class ConfigurationEvent : ModelEnum {
     ...
     * 'Changed' variant
     */
    public data class Changed(public val parameterChanged: ParameterChanged) : ConfigurationEvent() {
        ...
        public companion object :
            ...
            override fun write(writer: ScaleCodecWriter, instance: jp.co.soramitsu.iroha2.generated.ConfigurationEvent.Changed): Unit =
                try {
    ...
    public companion object : ScaleReader<ConfigurationEvent>, ScaleWriter<ConfigurationEvent> {
        override fun read(reader: ScaleCodecReader): ConfigurationEvent = when (val discriminant = reader.readUByte()) {
