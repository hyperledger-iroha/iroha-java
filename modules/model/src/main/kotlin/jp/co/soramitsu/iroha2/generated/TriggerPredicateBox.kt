...
public sealed class TriggerPredicateBox : ModelEnum {
     ...
     * 'Id' variant
     */
    public data class Id(public val triggerIdPredicateBox: TriggerIdPredicateBox) : TriggerPredicateBox() {
        ...
        public companion object :
            ...
            override fun write(writer: ScaleCodecWriter, instance: jp.co.soramitsu.iroha2.generated.TriggerPredicateBox.Id): Unit = try {
    ...
    public companion object : ScaleReader<TriggerPredicateBox>, ScaleWriter<TriggerPredicateBox> {
        override fun read(reader: ScaleCodecReader): TriggerPredicateBox = when (val discriminant = reader.readUByte()) {
            0 -> Id.read(reader)
