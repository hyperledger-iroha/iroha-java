...
public sealed class DomainIdPredicateAtom : ModelEnum {
    ...
    public data class Equals(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.DomainIdPredicateAtom.Equals =
                try {
                    Equals(
            ...
            override fun write(
                ...
                instance: jp.co.soramitsu.iroha2.generated.DomainIdPredicateAtom.Equals,
            ): Unit =
                try {
    ...
    public companion object : ScaleReader<DomainIdPredicateAtom>, ScaleWriter<DomainIdPredicateAtom> {
        override fun read(reader: ScaleCodecReader): DomainIdPredicateAtom =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: DomainIdPredicateAtom,
        ) {
