...
public sealed class AssetIdProjectionOfSelectorMarker : ModelEnum {
    ...
    public class Atom : AssetIdProjectionOfSelectorMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AssetIdProjectionOfSelectorMarker.Atom = try {
                Atom()
            } catch (ex: Exception) {
            ...
            public fun equals(o1: jp.co.soramitsu.iroha2.generated.AssetIdProjectionOfSelectorMarker.Atom, o2: Any?): Boolean = when (o2) {
                null -> false
     ...
     * 'Account' variant
     */
    public data class Account(public val accountIdProjectionOfSelectorMarker: AccountIdProjectionOfSelectorMarker) :
        AssetIdProjectionOfSelectorMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AssetIdProjectionOfSelectorMarker.Account = try {
                Account(
     ...
     * 'Definition' variant
     */
    public data class Definition(public val assetDefinitionIdProjectionOfSelectorMarker: AssetDefinitionIdProjectionOfSelectorMarker) :
        AssetIdProjectionOfSelectorMarker() {
        override fun discriminant(): Int = DISCRIMINANT
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): AssetIdProjectionOfSelectorMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
        ...
        override fun write(writer: ScaleCodecWriter, instance: AssetIdProjectionOfSelectorMarker) {
