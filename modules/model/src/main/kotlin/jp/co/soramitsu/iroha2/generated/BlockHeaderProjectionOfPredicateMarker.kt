...
public sealed class BlockHeaderProjectionOfPredicateMarker : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val blockHeaderPredicateAtom: BlockHeaderPredicateAtom) : BlockHeaderProjectionOfPredicateMarker() {
     ...
     * 'Hash' variant
     */
    public data class Hash(public val blockHeaderHashProjectionOfPredicateMarker: BlockHeaderHashProjectionOfPredicateMarker) :
        BlockHeaderProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): BlockHeaderProjectionOfPredicateMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            1 -> Hash.read(reader)
            else -> throw RuntimeException("Unresolved discriminant of the enum variant: $discriminant")
        }

        override fun write(writer: ScaleCodecWriter, instance: BlockHeaderProjectionOfPredicateMarker) {
