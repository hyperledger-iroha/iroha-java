...
public sealed class CommittedTransactionProjectionOfPredicateMarker : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val committedTransactionPredicateAtom: CommittedTransactionPredicateAtom) :
        CommittedTransactionProjectionOfPredicateMarker() {
        ...
        public companion object :
            ...
            ): jp.co.soramitsu.iroha2.generated.CommittedTransactionProjectionOfPredicateMarker.Atom = try {
                Atom(
     ...
     * 'BlockHash' variant
     */
    public data class BlockHash(public val blockHeaderHashProjectionOfPredicateMarker: BlockHeaderHashProjectionOfPredicateMarker) :
        CommittedTransactionProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(
                reader: ScaleCodecReader,
            ): jp.co.soramitsu.iroha2.generated.CommittedTransactionProjectionOfPredicateMarker.BlockHash = try {
                BlockHash(
     ...
     * 'Value' variant
     */
    public data class Value(public val signedTransactionProjectionOfPredicateMarker: SignedTransactionProjectionOfPredicateMarker) :
        CommittedTransactionProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(
                reader: ScaleCodecReader,
            ): jp.co.soramitsu.iroha2.generated.CommittedTransactionProjectionOfPredicateMarker.Value = try {
                Value(
     ...
     * 'Error' variant
     */
    public data class Error(public val transactionErrorProjectionOfPredicateMarker: TransactionErrorProjectionOfPredicateMarker) :
        CommittedTransactionProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(
                reader: ScaleCodecReader,
            ): jp.co.soramitsu.iroha2.generated.CommittedTransactionProjectionOfPredicateMarker.Error = try {
                Error(
    ...
    public companion object :
        ...
        override fun write(writer: ScaleCodecWriter, instance: CommittedTransactionProjectionOfPredicateMarker) {
