...
public sealed class AssetValuePredicateAtom : ModelEnum {
    ...
    public class IsNumeric : AssetValuePredicateAtom() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AssetValuePredicateAtom.IsNumeric = try {
                IsNumeric()
            } catch (ex: Exception) {
            ...
            public fun equals(o1: jp.co.soramitsu.iroha2.generated.AssetValuePredicateAtom.IsNumeric, o2: Any?): Boolean = when (o2) {
                null -> false
    ...
    public class IsStore : AssetValuePredicateAtom() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AssetValuePredicateAtom.IsStore = try {
                IsStore()
            } catch (ex: Exception) {
                throw wrapException(ex)
            }

            override fun write(writer: ScaleCodecWriter, instance: jp.co.soramitsu.iroha2.generated.AssetValuePredicateAtom.IsStore): Unit =
                try {
                } catch (ex: Exception) {
                    throw wrapException(ex)
                }

            public fun equals(o1: jp.co.soramitsu.iroha2.generated.AssetValuePredicateAtom.IsStore, o2: Any?): Boolean = when (o2) {
                null -> false
                else -> o2::class == o1::class
            }
