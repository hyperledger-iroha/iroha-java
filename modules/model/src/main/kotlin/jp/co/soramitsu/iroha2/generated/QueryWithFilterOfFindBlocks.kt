...
public data class QueryWithFilterOfFindBlocks(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): QueryWithFilterOfFindBlocks = try {
            QueryWithFilterOfFindBlocks(
        ...
        override fun write(writer: ScaleCodecWriter, instance: QueryWithFilterOfFindBlocks): Unit = try {
