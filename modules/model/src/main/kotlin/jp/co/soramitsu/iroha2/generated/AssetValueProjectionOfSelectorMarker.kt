...
public sealed class AssetValueProjectionOfSelectorMarker : ModelEnum {
    ...
    public class Atom : AssetValueProjectionOfSelectorMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AssetValueProjectionOfSelectorMarker.Atom =
                try {
                    Atom()
                } catch (ex: Exception) {
            ...
            public fun equals(
                o1: jp.co.soramitsu.iroha2.generated.AssetValueProjectionOfSelectorMarker.Atom,
                o2: Any?,
            ): Boolean =
                when (o2) {
                    null -> false
    ...
    public data class Numeric(
        public val numericProjectionOfSelectorMarker: NumericProjectionOfSelectorMarker,
    ) : AssetValueProjectionOfSelectorMarker() {
        override fun discriminant(): Int = DISCRIMINANT
    ...
    public data class Store(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AssetValueProjectionOfSelectorMarker.Store =
                try {
                    Store(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): AssetValueProjectionOfSelectorMarker =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: AssetValueProjectionOfSelectorMarker,
        ) {
