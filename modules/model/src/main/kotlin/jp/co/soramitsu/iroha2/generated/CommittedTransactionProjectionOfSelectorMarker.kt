...
public sealed class CommittedTransactionProjectionOfSelectorMarker : ModelEnum {
    ...
    public class Atom : CommittedTransactionProjectionOfSelectorMarker() {
        ...
        public companion object :
            ...
            ): jp.co.soramitsu.iroha2.generated.CommittedTransactionProjectionOfSelectorMarker.Atom = try {
                Atom()
            } catch (ex: Exception) {
            ...
            public fun equals(o1: jp.co.soramitsu.iroha2.generated.CommittedTransactionProjectionOfSelectorMarker.Atom, o2: Any?): Boolean =
                when (o2) {
                    null -> false
     ...
     * 'BlockHash' variant
     */
    public data class BlockHash(public val blockHeaderHashProjectionOfSelectorMarker: BlockHeaderHashProjectionOfSelectorMarker) :
        CommittedTransactionProjectionOfSelectorMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(
                reader: ScaleCodecReader,
            ): jp.co.soramitsu.iroha2.generated.CommittedTransactionProjectionOfSelectorMarker.BlockHash = try {
                BlockHash(
     ...
     * 'Value' variant
     */
    public data class Value(public val signedTransactionProjectionOfSelectorMarker: SignedTransactionProjectionOfSelectorMarker) :
        CommittedTransactionProjectionOfSelectorMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(
                reader: ScaleCodecReader,
            ): jp.co.soramitsu.iroha2.generated.CommittedTransactionProjectionOfSelectorMarker.Value = try {
                Value(
     ...
     * 'Error' variant
     */
    public data class Error(public val transactionErrorProjectionOfSelectorMarker: TransactionErrorProjectionOfSelectorMarker) :
        CommittedTransactionProjectionOfSelectorMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(
                reader: ScaleCodecReader,
            ): jp.co.soramitsu.iroha2.generated.CommittedTransactionProjectionOfSelectorMarker.Error = try {
                Error(
    ...
    public companion object :
        ...
        override fun write(writer: ScaleCodecWriter, instance: CommittedTransactionProjectionOfSelectorMarker) {
