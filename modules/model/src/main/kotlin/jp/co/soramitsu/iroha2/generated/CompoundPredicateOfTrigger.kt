...
public sealed class CompoundPredicateOfTrigger : ModelEnum {
    ...
    public data class Atom(
        public val triggerProjectionOfPredicateMarker: TriggerProjectionOfPredicateMarker,
    ) : CompoundPredicateOfTrigger() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfTrigger.Atom =
                try {
                    Atom(
            ...
            override fun write(
                ...
                instance: jp.co.soramitsu.iroha2.generated.CompoundPredicateOfTrigger.Atom,
            ): Unit =
                try {
    ...
    public data class Not(
        public val compoundPredicateOfTrigger: CompoundPredicateOfTrigger,
    ) : CompoundPredicateOfTrigger() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfTrigger.Not =
                try {
                    Not(
            ...
            override fun write(
                writer: ScaleCodecWriter,
                instance: jp.co.soramitsu.iroha2.generated.CompoundPredicateOfTrigger.Not,
            ): Unit =
                try {
    ...
    public data class And(
        public val vec: List<CompoundPredicateOfTrigger>,
    ) : CompoundPredicateOfTrigger() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfTrigger.And =
                try {
                    And(
            ...
            override fun write(
                writer: ScaleCodecWriter,
                instance: jp.co.soramitsu.iroha2.generated.CompoundPredicateOfTrigger.And,
            ): Unit =
                try {
    ...
    public data class Or(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfTrigger.Or =
                try {
                    Or(
                        reader.readVec(reader.readCompactInt()) { CompoundPredicateOfTrigger.read(reader) },
                    )
            ...
            override fun write(
                writer: ScaleCodecWriter,
                instance: jp.co.soramitsu.iroha2.generated.CompoundPredicateOfTrigger.Or,
            ): Unit =
                try {
                    writer.writeCompact(instance.vec.size)
                    instance.vec.forEach { value ->
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): CompoundPredicateOfTrigger =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: CompoundPredicateOfTrigger,
        ) {
