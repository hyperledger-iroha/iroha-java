...
public data class CanRegisterAssetDefinition(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): CanRegisterAssetDefinition = try {
            CanRegisterAssetDefinition(
        ...
        override fun write(writer: ScaleCodecWriter, instance: CanRegisterAssetDefinition): Unit = try {
