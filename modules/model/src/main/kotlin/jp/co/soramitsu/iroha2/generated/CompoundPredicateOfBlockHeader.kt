...
public sealed class CompoundPredicateOfBlockHeader : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val blockHeaderProjectionOfPredicateMarker: BlockHeaderProjectionOfPredicateMarker) :
        CompoundPredicateOfBlockHeader() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfBlockHeader.Atom = try {
                Atom(
     ...
     * 'Not' variant
     */
    public data class Not(public val compoundPredicateOfBlockHeader: CompoundPredicateOfBlockHeader) : CompoundPredicateOfBlockHeader() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfBlockHeader.Not = try {
                Not(
     ...
     * 'And' variant
     */
    public data class And(public val vec: List<CompoundPredicateOfBlockHeader>) : CompoundPredicateOfBlockHeader() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfBlockHeader.And = try {
                And(
     ...
     * 'Or' variant
     */
    public data class Or(public val vec: List<CompoundPredicateOfBlockHeader>) : CompoundPredicateOfBlockHeader() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfBlockHeader.Or = try {
                Or(
                    reader.readVec(reader.readCompactInt()) { CompoundPredicateOfBlockHeader.read(reader) },
                )
            } catch (ex: Exception) {
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): CompoundPredicateOfBlockHeader = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            1 -> Not.read(reader)
            2 -> And.read(reader)
            3 -> Or.read(reader)
        ...
        override fun write(writer: ScaleCodecWriter, instance: CompoundPredicateOfBlockHeader) {
