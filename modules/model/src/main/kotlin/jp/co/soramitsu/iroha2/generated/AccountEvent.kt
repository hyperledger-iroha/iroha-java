...
public sealed class AccountEvent : ModelEnum {
    ...
    public data class Created(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AccountEvent.Created =
                try {
                    Created(
                        Account.read(reader),
                    )
    ...
    public data class Deleted(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AccountEvent.Deleted =
                try {
                    Deleted(
    ...
    public data class Asset(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AccountEvent.Asset =
                try {
                    Asset(
    ...
    public data class PermissionAdded(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AccountEvent.PermissionAdded =
                try {
                    PermissionAdded(
    ...
    public data class PermissionRemoved(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AccountEvent.PermissionRemoved =
                try {
                    PermissionRemoved(
                        AccountPermissionChanged.read(reader),
                    )
    ...
    public data class RoleGranted(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AccountEvent.RoleGranted =
                try {
                    RoleGranted(
    ...
    public data class RoleRevoked(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AccountEvent.RoleRevoked =
                try {
                    RoleRevoked(
                        AccountRoleChanged.read(reader),
                    )
    ...
    public data class MetadataInserted(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AccountEvent.MetadataInserted =
                try {
                    MetadataInserted(
    ...
    public data class MetadataRemoved(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AccountEvent.MetadataRemoved =
                try {
                    MetadataRemoved(
                        MetadataChangedOfAccountId.read(reader),
                    )
    ...
    public companion object : ScaleReader<AccountEvent>, ScaleWriter<AccountEvent> {
        override fun read(reader: ScaleCodecReader): AccountEvent =
