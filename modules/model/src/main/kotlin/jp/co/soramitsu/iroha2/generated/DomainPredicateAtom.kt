...
public sealed class DomainPredicateAtom : ModelEnum {
    ...
    public companion object : ScaleReader<DomainPredicateAtom>, ScaleWriter<DomainPredicateAtom> {
        override fun read(reader: ScaleCodecReader): DomainPredicateAtom = when (val discriminant = reader.readUByte()) {
            else -> throw RuntimeException("Unresolved discriminant of the enum variant: $discriminant")
        }

        override fun write(writer: ScaleCodecWriter, instance: DomainPredicateAtom) {
