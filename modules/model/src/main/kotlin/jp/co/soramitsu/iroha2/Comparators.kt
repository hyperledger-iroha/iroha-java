...
fun AccountId.Companion.comparator() =
    compareBy<AccountId> { it.domain.name.string }.thenComparator { o1, o2 ->
...
fun AssetDefinitionId.Companion.comparator() =
    compareBy<AssetDefinitionId> { it.name.string }
...
fun AssetId.Companion.comparator() =
    Comparator<AssetId> { o1, o2 ->
...
fun PublicKey.Companion.comparator() =
    Comparator<PublicKey> { o1, o2 ->
...
fun SignatureOf.Companion.comparator() =
    Comparator<SignatureOf<*>> { o1, o2 ->
...
fun Permission.Companion.comparator() =
    compareBy<Permission> {
        it.name
    }.thenComparator { o1, o2 ->
...
fun CustomParameterId.Companion.comparator() =
    compareBy<CustomParameterId> {
        it.name.string
    }

private fun KClass<ByteArray>.comparator() =
    Comparator<ByteArray> { o1, o2 ->
        if (o1.size != o2.size) {
