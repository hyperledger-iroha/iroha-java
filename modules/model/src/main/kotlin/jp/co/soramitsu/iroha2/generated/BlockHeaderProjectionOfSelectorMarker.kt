...
public sealed class BlockHeaderProjectionOfSelectorMarker : ModelEnum {
    ...
    public class Atom : BlockHeaderProjectionOfSelectorMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.BlockHeaderProjectionOfSelectorMarker.Atom =
                try {
                    Atom()
                } catch (ex: Exception) {
            ...
            public fun equals(
                o1: jp.co.soramitsu.iroha2.generated.BlockHeaderProjectionOfSelectorMarker.Atom,
                o2: Any?,
            ): Boolean =
                when (o2) {
                    null -> false
    ...
    public data class Hash(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.BlockHeaderProjectionOfSelectorMarker.Hash =
                try {
                    Hash(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): BlockHeaderProjectionOfSelectorMarker =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: BlockHeaderProjectionOfSelectorMarker,
        ) {
