...
public sealed class SignedBlockProjectionOfPredicateMarker : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val signedBlockPredicateAtom: SignedBlockPredicateAtom) : SignedBlockProjectionOfPredicateMarker() {
     ...
     * 'Header' variant
     */
    public data class Header(public val blockHeaderProjectionOfPredicateMarker: BlockHeaderProjectionOfPredicateMarker) :
        SignedBlockProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): SignedBlockProjectionOfPredicateMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            1 -> Header.read(reader)
            else -> throw RuntimeException("Unresolved discriminant of the enum variant: $discriminant")
        }

        override fun write(writer: ScaleCodecWriter, instance: SignedBlockProjectionOfPredicateMarker) {
