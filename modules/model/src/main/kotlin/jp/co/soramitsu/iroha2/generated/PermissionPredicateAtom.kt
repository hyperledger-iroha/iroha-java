...
public sealed class PermissionPredicateAtom : ModelEnum {
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): PermissionPredicateAtom = when (val discriminant = reader.readUByte()) {
            else -> throw RuntimeException("Unresolved discriminant of the enum variant: $discriminant")
        }

        override fun write(writer: ScaleCodecWriter, instance: PermissionPredicateAtom) {
