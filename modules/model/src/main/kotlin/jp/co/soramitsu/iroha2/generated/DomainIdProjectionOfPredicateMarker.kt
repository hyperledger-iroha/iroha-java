...
public sealed class DomainIdProjectionOfPredicateMarker : ModelEnum {
    ...
    public data class Atom(
        public val domainIdPredicateAtom: DomainIdPredicateAtom,
    ) : DomainIdProjectionOfPredicateMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.DomainIdProjectionOfPredicateMarker.Atom =
                try {
                    Atom(
    ...
    public data class Name(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.DomainIdProjectionOfPredicateMarker.Name =
                try {
                    Name(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): DomainIdProjectionOfPredicateMarker =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: DomainIdProjectionOfPredicateMarker,
        ) {
