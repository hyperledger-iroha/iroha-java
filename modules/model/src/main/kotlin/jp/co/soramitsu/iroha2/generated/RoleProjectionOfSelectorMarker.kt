...
public sealed class RoleProjectionOfSelectorMarker : ModelEnum {
    ...
    public class Atom : RoleProjectionOfSelectorMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.RoleProjectionOfSelectorMarker.Atom = try {
                Atom()
            } catch (ex: Exception) {
            ...
            public fun equals(o1: jp.co.soramitsu.iroha2.generated.RoleProjectionOfSelectorMarker.Atom, o2: Any?): Boolean = when (o2) {
                null -> false
     ...
     * 'Id' variant
     */
    public data class Id(public val roleIdProjectionOfSelectorMarker: RoleIdProjectionOfSelectorMarker) : RoleProjectionOfSelectorMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.RoleProjectionOfSelectorMarker.Id = try {
                Id(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): RoleProjectionOfSelectorMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            1 -> Id.read(reader)
            else -> throw RuntimeException("Unresolved discriminant of the enum variant: $discriminant")
        }

        override fun write(writer: ScaleCodecWriter, instance: RoleProjectionOfSelectorMarker) {
