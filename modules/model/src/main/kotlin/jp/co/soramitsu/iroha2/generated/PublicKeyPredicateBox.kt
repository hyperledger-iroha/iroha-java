...
public sealed class PublicKeyPredicateBox : ModelEnum {
     ...
     * 'Equals' variant
     */
    public data class Equals(public val publicKey: PublicKey) : PublicKeyPredicateBox() {
        ...
        public companion object :
            ...
            override fun write(writer: ScaleCodecWriter, instance: jp.co.soramitsu.iroha2.generated.PublicKeyPredicateBox.Equals): Unit =
                try {
    ...
    public companion object : ScaleReader<PublicKeyPredicateBox>, ScaleWriter<PublicKeyPredicateBox> {
        override fun read(reader: ScaleCodecReader): PublicKeyPredicateBox = when (val discriminant = reader.readUByte()) {
