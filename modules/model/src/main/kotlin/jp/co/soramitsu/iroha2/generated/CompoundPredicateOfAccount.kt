...
public sealed class CompoundPredicateOfAccount : ModelEnum {
    ...
    public data class Atom(
        public val accountProjectionOfPredicateMarker: AccountProjectionOfPredicateMarker,
    ) : CompoundPredicateOfAccount() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfAccount.Atom =
                try {
                    Atom(
            ...
            override fun write(
                ...
                instance: jp.co.soramitsu.iroha2.generated.CompoundPredicateOfAccount.Atom,
            ): Unit =
                try {
    ...
    public data class Not(
        public val compoundPredicateOfAccount: CompoundPredicateOfAccount,
    ) : CompoundPredicateOfAccount() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfAccount.Not =
                try {
                    Not(
            ...
            override fun write(
                writer: ScaleCodecWriter,
                instance: jp.co.soramitsu.iroha2.generated.CompoundPredicateOfAccount.Not,
            ): Unit =
                try {
    ...
    public data class And(
        public val vec: List<CompoundPredicateOfAccount>,
    ) : CompoundPredicateOfAccount() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfAccount.And =
                try {
                    And(
            ...
            override fun write(
                writer: ScaleCodecWriter,
                instance: jp.co.soramitsu.iroha2.generated.CompoundPredicateOfAccount.And,
            ): Unit =
                try {
    ...
    public data class Or(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfAccount.Or =
                try {
                    Or(
                        reader.readVec(reader.readCompactInt()) { CompoundPredicateOfAccount.read(reader) },
                    )
            ...
            override fun write(
                writer: ScaleCodecWriter,
                instance: jp.co.soramitsu.iroha2.generated.CompoundPredicateOfAccount.Or,
            ): Unit =
                try {
                    writer.writeCompact(instance.vec.size)
                    instance.vec.forEach { value ->
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): CompoundPredicateOfAccount =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: CompoundPredicateOfAccount,
        ) {
