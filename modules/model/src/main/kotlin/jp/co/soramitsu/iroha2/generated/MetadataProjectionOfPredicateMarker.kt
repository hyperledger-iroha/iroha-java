...
public sealed class MetadataProjectionOfPredicateMarker : ModelEnum {
    ...
    public data class Atom(
        public val metadataPredicateAtom: MetadataPredicateAtom,
    ) : MetadataProjectionOfPredicateMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.MetadataProjectionOfPredicateMarker.Atom =
                try {
                    Atom(
    ...
    public data class Key(
        public val metadataKeyProjectionOfPredicateMarker: MetadataKeyProjectionOfPredicateMarker,
    ) : MetadataProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.MetadataProjectionOfPredicateMarker.Key =
                try {
                    Key(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): MetadataProjectionOfPredicateMarker =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: MetadataProjectionOfPredicateMarker,
        ) {
