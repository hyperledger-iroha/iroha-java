 ...
 */
public data class SelectorTupleOfTrigger(public val vecOfTriggerProjectionOfSelectorMarker: List<TriggerProjectionOfSelectorMarker>) {
    public companion object :
        ScaleReader<SelectorTupleOfTrigger>,
        ScaleWriter<SelectorTupleOfTrigger> {
        override fun read(reader: ScaleCodecReader): SelectorTupleOfTrigger = try {
            SelectorTupleOfTrigger(
        ...
        override fun write(writer: ScaleCodecWriter, instance: SelectorTupleOfTrigger): Unit = try {
