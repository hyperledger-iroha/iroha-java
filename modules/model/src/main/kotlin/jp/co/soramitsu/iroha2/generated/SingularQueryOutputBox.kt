...
public sealed class SingularQueryOutputBox : ModelEnum {
    ...
    public data class ExecutorDataModel(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.SingularQueryOutputBox.ExecutorDataModel =
                try {
                    ExecutorDataModel(
                        jp.co.soramitsu.iroha2.generated.ExecutorDataModel
                            .read(reader),
                    )
                } catch (ex: Exception) {
            ...
            override fun write(
                ...
                try {
                    jp.co.soramitsu.iroha2.generated.ExecutorDataModel
                        .write(writer, instance.executorDataModel)
                } catch (ex: Exception) {
                    throw wrapException(ex)
                }
        }
    ...
    public data class Parameters(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.SingularQueryOutputBox.Parameters =
                try {
                    Parameters(
                        jp.co.soramitsu.iroha2.generated.Parameters
                            .read(reader),
                    )
                } catch (ex: Exception) {
                    throw wrapException(ex)
            ...
            override fun write(
                ...
                try {
                    jp.co.soramitsu.iroha2.generated.Parameters
                        .write(writer, instance.parameters)
                } catch (ex: Exception) {
                    throw wrapException(ex)
                }
        }
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): SingularQueryOutputBox =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: SingularQueryOutputBox,
        ) {
