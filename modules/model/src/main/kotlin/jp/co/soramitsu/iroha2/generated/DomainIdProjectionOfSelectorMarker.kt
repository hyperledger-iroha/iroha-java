...
public sealed class DomainIdProjectionOfSelectorMarker : ModelEnum {
    ...
    public class Atom : DomainIdProjectionOfSelectorMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.DomainIdProjectionOfSelectorMarker.Atom = try {
                Atom()
            } catch (ex: Exception) {
            ...
            public fun equals(o1: jp.co.soramitsu.iroha2.generated.DomainIdProjectionOfSelectorMarker.Atom, o2: Any?): Boolean = when (o2) {
                null -> false
    ...
    public data class Name(public val nameProjectionOfSelectorMarker: NameProjectionOfSelectorMarker) :
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.DomainIdProjectionOfSelectorMarker.Name = try {
                Name(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): DomainIdProjectionOfSelectorMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            1 -> Name.read(reader)
            else -> throw RuntimeException("Unresolved discriminant of the enum variant: $discriminant")
        }

        override fun write(writer: ScaleCodecWriter, instance: DomainIdProjectionOfSelectorMarker) {
