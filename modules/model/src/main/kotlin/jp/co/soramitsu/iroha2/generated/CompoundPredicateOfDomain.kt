...
public sealed class CompoundPredicateOfDomain : ModelEnum {
    ...
    public data class Atom(
        public val domainProjectionOfPredicateMarker: DomainProjectionOfPredicateMarker,
    ) : CompoundPredicateOfDomain() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfDomain.Atom =
                try {
                    Atom(
            ...
            override fun write(
                ...
                instance: jp.co.soramitsu.iroha2.generated.CompoundPredicateOfDomain.Atom,
            ): Unit =
                try {
    ...
    public data class Not(
        public val compoundPredicateOfDomain: CompoundPredicateOfDomain,
    ) : CompoundPredicateOfDomain() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfDomain.Not =
                try {
                    Not(
            ...
            override fun write(
                writer: ScaleCodecWriter,
                instance: jp.co.soramitsu.iroha2.generated.CompoundPredicateOfDomain.Not,
            ): Unit =
                try {
    ...
    public data class And(
        public val vec: List<CompoundPredicateOfDomain>,
    ) : CompoundPredicateOfDomain() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfDomain.And =
                try {
                    And(
            ...
            override fun write(
                writer: ScaleCodecWriter,
                instance: jp.co.soramitsu.iroha2.generated.CompoundPredicateOfDomain.And,
            ): Unit =
                try {
    ...
    public data class Or(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfDomain.Or =
                try {
                    Or(
                        reader.readVec(reader.readCompactInt()) { CompoundPredicateOfDomain.read(reader) },
                    )
            ...
            override fun write(
                writer: ScaleCodecWriter,
                instance: jp.co.soramitsu.iroha2.generated.CompoundPredicateOfDomain.Or,
            ): Unit =
                try {
                    writer.writeCompact(instance.vec.size)
                    instance.vec.forEach { value ->
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): CompoundPredicateOfDomain =
