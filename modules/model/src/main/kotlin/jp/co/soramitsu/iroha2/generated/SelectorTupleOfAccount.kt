 ...
 */
public data class SelectorTupleOfAccount(
    public val vecOfAccountProjectionOfSelectorMarker: List<AccountProjectionOfSelectorMarker>,
) {
    public companion object :
        ScaleReader<SelectorTupleOfAccount>,
        ScaleWriter<SelectorTupleOfAccount> {
        override fun read(reader: ScaleCodecReader): SelectorTupleOfAccount =
            try {
                SelectorTupleOfAccount(
        ...
        override fun write(
            ...
            instance: SelectorTupleOfAccount,
        ): Unit =
            try {
