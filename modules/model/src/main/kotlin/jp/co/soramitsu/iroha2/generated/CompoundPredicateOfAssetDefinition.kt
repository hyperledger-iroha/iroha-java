...
public sealed class CompoundPredicateOfAssetDefinition : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val assetDefinitionProjectionOfPredicateMarker: AssetDefinitionProjectionOfPredicateMarker) :
        CompoundPredicateOfAssetDefinition() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfAssetDefinition.Atom = try {
                Atom(
     ...
     * 'Not' variant
     */
    public data class Not(public val compoundPredicateOfAssetDefinition: CompoundPredicateOfAssetDefinition) :
        CompoundPredicateOfAssetDefinition() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfAssetDefinition.Not = try {
                Not(
     ...
     * 'And' variant
     */
    public data class And(public val vec: List<CompoundPredicateOfAssetDefinition>) : CompoundPredicateOfAssetDefinition() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfAssetDefinition.And = try {
                And(
     ...
     * 'Or' variant
     */
    public data class Or(public val vec: List<CompoundPredicateOfAssetDefinition>) : CompoundPredicateOfAssetDefinition() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfAssetDefinition.Or = try {
                Or(
                    reader.readVec(reader.readCompactInt()) { CompoundPredicateOfAssetDefinition.read(reader) },
                )
            } catch (ex: Exception) {
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): CompoundPredicateOfAssetDefinition = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            1 -> Not.read(reader)
            2 -> And.read(reader)
            3 -> Or.read(reader)
        ...
        override fun write(writer: ScaleCodecWriter, instance: CompoundPredicateOfAssetDefinition) {
