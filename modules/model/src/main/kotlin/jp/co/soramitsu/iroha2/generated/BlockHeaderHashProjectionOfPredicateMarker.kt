...
public sealed class BlockHeaderHashProjectionOfPredicateMarker : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val blockHeaderHashPredicateAtom: BlockHeaderHashPredicateAtom) :
        BlockHeaderHashProjectionOfPredicateMarker() {
    ...
    public companion object :
        ...
        override fun write(writer: ScaleCodecWriter, instance: BlockHeaderHashProjectionOfPredicateMarker) {
