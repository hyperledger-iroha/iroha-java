...
public sealed class CompoundPredicateOfSignedBlock : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val signedBlockProjectionOfPredicateMarker: SignedBlockProjectionOfPredicateMarker) :
        CompoundPredicateOfSignedBlock() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfSignedBlock.Atom = try {
                Atom(
     ...
     * 'Not' variant
     */
    public data class Not(public val compoundPredicateOfSignedBlock: CompoundPredicateOfSignedBlock) : CompoundPredicateOfSignedBlock() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfSignedBlock.Not = try {
                Not(
     ...
     * 'And' variant
     */
    public data class And(public val vec: List<CompoundPredicateOfSignedBlock>) : CompoundPredicateOfSignedBlock() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfSignedBlock.And = try {
                And(
     ...
     * 'Or' variant
     */
    public data class Or(public val vec: List<CompoundPredicateOfSignedBlock>) : CompoundPredicateOfSignedBlock() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.CompoundPredicateOfSignedBlock.Or = try {
                Or(
                    reader.readVec(reader.readCompactInt()) { CompoundPredicateOfSignedBlock.read(reader) },
                )
            } catch (ex: Exception) {
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): CompoundPredicateOfSignedBlock = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            1 -> Not.read(reader)
            2 -> And.read(reader)
            3 -> Or.read(reader)
        ...
        override fun write(writer: ScaleCodecWriter, instance: CompoundPredicateOfSignedBlock) {
