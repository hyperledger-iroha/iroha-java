...
public data class CanModifyDomainMetadata(public val domain: DomainId) : ModelPermission {
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): CanModifyDomainMetadata = try {
            CanModifyDomainMetadata(
        ...
        override fun write(writer: ScaleCodecWriter, instance: CanModifyDomainMetadata): Unit = try {
