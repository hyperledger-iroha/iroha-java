...
public sealed class AssetDefinitionPredicateAtom : ModelEnum {
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): AssetDefinitionPredicateAtom = when (val discriminant = reader.readUByte()) {
            else -> throw RuntimeException("Unresolved discriminant of the enum variant: $discriminant")
        }

        override fun write(writer: ScaleCodecWriter, instance: AssetDefinitionPredicateAtom) {
