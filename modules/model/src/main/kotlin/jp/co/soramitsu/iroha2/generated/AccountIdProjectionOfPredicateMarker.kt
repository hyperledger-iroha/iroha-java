...
public sealed class AccountIdProjectionOfPredicateMarker : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val accountIdPredicateAtom: AccountIdPredicateAtom) : AccountIdProjectionOfPredicateMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AccountIdProjectionOfPredicateMarker.Atom = try {
                Atom(
     ...
     * 'Domain' variant
     */
    public data class Domain(public val domainIdProjectionOfPredicateMarker: DomainIdProjectionOfPredicateMarker) :
        AccountIdProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
     ...
     * 'Signatory' variant
     */
    public data class Signatory(public val publicKeyProjectionOfPredicateMarker: PublicKeyProjectionOfPredicateMarker) :
        AccountIdProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): AccountIdProjectionOfPredicateMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
        ...
        override fun write(writer: ScaleCodecWriter, instance: AccountIdProjectionOfPredicateMarker) {
