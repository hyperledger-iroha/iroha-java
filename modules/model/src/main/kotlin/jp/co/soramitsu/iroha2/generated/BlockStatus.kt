...
public sealed class BlockStatus : ModelEnum {
    ...
    override fun equals(other: Any?): Boolean =
        when (this) {
            is Created -> Created.equals(this, other)
     ...
     * 'Created' variant
     */
    public class Created : BlockStatus() {
        override fun discriminant(): Int = DISCRIMINANT

        public companion object :
            ScaleReader<jp.co.soramitsu.iroha2.generated.BlockStatus.Created>,
            ScaleWriter<jp.co.soramitsu.iroha2.generated.BlockStatus.Created> {
            public const val DISCRIMINANT: Int = 0

            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.BlockStatus.Created =
                try {
                    Created()
                } catch (ex: Exception) {
            ...
            public fun equals(
                o1: jp.co.soramitsu.iroha2.generated.BlockStatus.Created,
                o2: Any?,
            ): Boolean =
                when (o2) {
                    null -> false
            ...
            override fun hashCode(): Int = ".BlockStatus.Created".hashCode()
        }
    }
    ...
    public class Approved : BlockStatus() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.BlockStatus.Approved =
                try {
                    Approved()
                } catch (ex: Exception) {
                    throw wrapException(ex)
            ...
            public fun equals(
                o1: jp.co.soramitsu.iroha2.generated.BlockStatus.Approved,
                o2: Any?,
            ): Boolean =
                when (o2) {
                    null -> false
    ...
    public data class Rejected(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.BlockStatus.Rejected =
                try {
                    Rejected(
    ...
    public class Committed : BlockStatus() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.BlockStatus.Committed =
                try {
                    Committed()
                } catch (ex: Exception) {
                    throw wrapException(ex)
            ...
            public fun equals(
                o1: jp.co.soramitsu.iroha2.generated.BlockStatus.Committed,
                o2: Any?,
            ): Boolean =
                when (o2) {
                    null -> false
    ...
    public class Applied : BlockStatus() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.BlockStatus.Applied =
                try {
                    Applied()
                } catch (ex: Exception) {
                    throw wrapException(ex)
            ...
            public fun equals(
                o1: jp.co.soramitsu.iroha2.generated.BlockStatus.Applied,
                o2: Any?,
            ): Boolean =
                when (o2) {
                    null -> false
    ...
    public companion object : ScaleReader<BlockStatus>, ScaleWriter<BlockStatus> {
        override fun read(reader: ScaleCodecReader): BlockStatus =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: BlockStatus,
        ) {
            writer.directWrite(instance.discriminant())
            when (val discriminant = instance.discriminant()) {
                0 -> Created.write(writer, instance as Created)
                1 -> Approved.write(writer, instance as Approved)
