...
public sealed class BlockStatus : ModelEnum {
    ...
    public class Created : BlockStatus() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.BlockStatus.Created = try {
                Created()
            } catch (ex: Exception) {
            ...
            public fun equals(o1: jp.co.soramitsu.iroha2.generated.BlockStatus.Created, o2: Any?): Boolean = when (o2) {
                null -> false
