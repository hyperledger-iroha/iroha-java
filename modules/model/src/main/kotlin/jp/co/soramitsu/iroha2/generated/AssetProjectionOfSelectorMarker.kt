...
public sealed class AssetProjectionOfSelectorMarker : ModelEnum {
    ...
    public class Atom : AssetProjectionOfSelectorMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AssetProjectionOfSelectorMarker.Atom = try {
                Atom()
            } catch (ex: Exception) {
            ...
            public fun equals(o1: jp.co.soramitsu.iroha2.generated.AssetProjectionOfSelectorMarker.Atom, o2: Any?): Boolean = when (o2) {
                null -> false
     ...
     * 'Id' variant
     */
    public data class Id(public val assetIdProjectionOfSelectorMarker: AssetIdProjectionOfSelectorMarker) :
        AssetProjectionOfSelectorMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AssetProjectionOfSelectorMarker.Id = try {
                Id(
     ...
     * 'Value' variant
     */
    public data class Value(public val assetValueProjectionOfSelectorMarker: AssetValueProjectionOfSelectorMarker) :
        AssetProjectionOfSelectorMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AssetProjectionOfSelectorMarker.Value = try {
                Value(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): AssetProjectionOfSelectorMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            1 -> Id.read(reader)
            2 -> Value.read(reader)
        ...
        override fun write(writer: ScaleCodecWriter, instance: AssetProjectionOfSelectorMarker) {
