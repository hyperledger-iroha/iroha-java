...
public sealed class TransactionStatus : ModelEnum {
    ...
    public class Queued : TransactionStatus() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.TransactionStatus.Queued =
                try {
                    Queued()
                } catch (ex: Exception) {
            ...
            public fun equals(
                o1: jp.co.soramitsu.iroha2.generated.TransactionStatus.Queued,
                o2: Any?,
            ): Boolean =
                when (o2) {
                    null -> false
    ...
    public class Expired : TransactionStatus() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.TransactionStatus.Expired =
                try {
                    Expired()
                } catch (ex: Exception) {
                    throw wrapException(ex)
            ...
            public fun equals(
                o1: jp.co.soramitsu.iroha2.generated.TransactionStatus.Expired,
                o2: Any?,
            ): Boolean =
                when (o2) {
                    null -> false
    ...
    public class Approved : TransactionStatus() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.TransactionStatus.Approved =
                try {
                    Approved()
                } catch (ex: Exception) {
                    throw wrapException(ex)
            ...
            public fun equals(
                o1: jp.co.soramitsu.iroha2.generated.TransactionStatus.Approved,
                o2: Any?,
            ): Boolean =
                when (o2) {
                    null -> false
    ...
    public data class Rejected(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.TransactionStatus.Rejected =
                try {
                    Rejected(
    ...
    public companion object : ScaleReader<TransactionStatus>, ScaleWriter<TransactionStatus> {
        override fun read(reader: ScaleCodecReader): TransactionStatus =
