...
public data class QueryWithFilterOfFindDomains(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): QueryWithFilterOfFindDomains = try {
            QueryWithFilterOfFindDomains(
        ...
        override fun write(writer: ScaleCodecWriter, instance: QueryWithFilterOfFindDomains): Unit = try {
