...
public sealed class TriggerProjectionOfSelectorMarker : ModelEnum {
    ...
    public class Atom : TriggerProjectionOfSelectorMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.TriggerProjectionOfSelectorMarker.Atom = try {
                Atom()
            } catch (ex: Exception) {
            ...
            public fun equals(o1: jp.co.soramitsu.iroha2.generated.TriggerProjectionOfSelectorMarker.Atom, o2: Any?): Boolean = when (o2) {
                null -> false
     ...
     * 'Id' variant
     */
    public data class Id(public val triggerIdProjectionOfSelectorMarker: TriggerIdProjectionOfSelectorMarker) :
        TriggerProjectionOfSelectorMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.TriggerProjectionOfSelectorMarker.Id = try {
                Id(
     ...
     * 'Action' variant
     */
    public data class Action(public val actionProjectionOfSelectorMarker: ActionProjectionOfSelectorMarker) :
        TriggerProjectionOfSelectorMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.TriggerProjectionOfSelectorMarker.Action = try {
                Action(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): TriggerProjectionOfSelectorMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            1 -> Id.read(reader)
        ...
        override fun write(writer: ScaleCodecWriter, instance: TriggerProjectionOfSelectorMarker) {
