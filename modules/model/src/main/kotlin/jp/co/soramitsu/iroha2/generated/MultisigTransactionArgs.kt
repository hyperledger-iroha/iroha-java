...
public sealed class MultisigTransactionArgs : ModelEnum {
    ...
    public data class Propose(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.MultisigTransactionArgs.Propose =
                try {
                    Propose(
    ...
    public data class Approve(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.MultisigTransactionArgs.Approve =
                try {
                    Approve(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): MultisigTransactionArgs =
            when (
                val discriminant =
                    reader.readUByte()
            ) {
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: MultisigTransactionArgs,
        ) {
