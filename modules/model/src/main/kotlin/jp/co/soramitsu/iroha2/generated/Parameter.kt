...
public sealed class Parameter : ModelEnum {
    ...
    public data class Sumeragi(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.Parameter.Sumeragi =
                try {
                    Sumeragi(
    ...
    public data class Block(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.Parameter.Block =
                try {
                    Block(
    ...
    public data class Transaction(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.Parameter.Transaction =
                try {
                    Transaction(
    ...
    public data class SmartContract(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.Parameter.SmartContract =
                try {
                    SmartContract(
    ...
    public data class Executor(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.Parameter.Executor =
                try {
                    Executor(
                        SmartContractParameter.read(reader),
                    )
    ...
    public data class Custom(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.Parameter.Custom =
                try {
                    Custom(
    ...
    public companion object : ScaleReader<Parameter>, ScaleWriter<Parameter> {
        override fun read(reader: ScaleCodecReader): Parameter =
