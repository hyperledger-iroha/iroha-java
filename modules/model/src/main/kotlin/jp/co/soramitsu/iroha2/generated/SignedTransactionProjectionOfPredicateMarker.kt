...
public sealed class SignedTransactionProjectionOfPredicateMarker : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val signedTransactionPredicateAtom: SignedTransactionPredicateAtom) :
        SignedTransactionProjectionOfPredicateMarker() {
        ...
        public companion object :
            ...
            ): jp.co.soramitsu.iroha2.generated.SignedTransactionProjectionOfPredicateMarker.Atom = try {
                Atom(
     ...
     * 'Hash' variant
     */
    public data class Hash(public val transactionHashProjectionOfPredicateMarker: TransactionHashProjectionOfPredicateMarker) :
        SignedTransactionProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(
                reader: ScaleCodecReader,
            ): jp.co.soramitsu.iroha2.generated.SignedTransactionProjectionOfPredicateMarker.Hash = try {
                Hash(
     ...
     * 'Authority' variant
     */
    public data class Authority(public val accountIdProjectionOfPredicateMarker: AccountIdProjectionOfPredicateMarker) :
        SignedTransactionProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(
                reader: ScaleCodecReader,
            ): jp.co.soramitsu.iroha2.generated.SignedTransactionProjectionOfPredicateMarker.Authority = try {
                Authority(
    ...
    public companion object :
        ...
        override fun write(writer: ScaleCodecWriter, instance: SignedTransactionProjectionOfPredicateMarker) {
