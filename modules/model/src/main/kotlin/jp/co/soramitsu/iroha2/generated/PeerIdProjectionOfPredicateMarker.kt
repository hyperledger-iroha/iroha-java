...
public sealed class PeerIdProjectionOfPredicateMarker : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val peerIdPredicateAtom: PeerIdPredicateAtom) : PeerIdProjectionOfPredicateMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.PeerIdProjectionOfPredicateMarker.Atom = try {
                Atom(
     ...
     * 'PublicKey' variant
     */
    public data class PublicKey(public val publicKeyProjectionOfPredicateMarker: PublicKeyProjectionOfPredicateMarker) :
        PeerIdProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): PeerIdProjectionOfPredicateMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
            1 -> PublicKey.read(reader)
            else -> throw RuntimeException("Unresolved discriminant of the enum variant: $discriminant")
        }

        override fun write(writer: ScaleCodecWriter, instance: PeerIdProjectionOfPredicateMarker) {
