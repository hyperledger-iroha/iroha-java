...
public sealed class InstructionEvaluationError : ModelEnum {
    ...
    public data class Unsupported(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.InstructionEvaluationError.Unsupported =
                try {
                    Unsupported(
    ...
    public data class Type(
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.InstructionEvaluationError.Type =
                try {
                    Type(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): InstructionEvaluationError =
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: InstructionEvaluationError,
        ) {
