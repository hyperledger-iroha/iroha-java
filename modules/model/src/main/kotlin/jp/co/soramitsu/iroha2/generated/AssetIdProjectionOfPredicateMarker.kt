...
public sealed class AssetIdProjectionOfPredicateMarker : ModelEnum {
     ...
     * 'Atom' variant
     */
    public data class Atom(public val assetIdPredicateAtom: AssetIdPredicateAtom) : AssetIdProjectionOfPredicateMarker() {
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AssetIdProjectionOfPredicateMarker.Atom = try {
                Atom(
     ...
     * 'Account' variant
     */
    public data class Account(public val accountIdProjectionOfPredicateMarker: AccountIdProjectionOfPredicateMarker) :
        AssetIdProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
        ...
        public companion object :
            ...
            override fun read(reader: ScaleCodecReader): jp.co.soramitsu.iroha2.generated.AssetIdProjectionOfPredicateMarker.Account = try {
                Account(
     ...
     * 'Definition' variant
     */
    public data class Definition(public val assetDefinitionIdProjectionOfPredicateMarker: AssetDefinitionIdProjectionOfPredicateMarker) :
        AssetIdProjectionOfPredicateMarker() {
        override fun discriminant(): Int = DISCRIMINANT
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): AssetIdProjectionOfPredicateMarker = when (val discriminant = reader.readUByte()) {
            0 -> Atom.read(reader)
        ...
        override fun write(writer: ScaleCodecWriter, instance: AssetIdProjectionOfPredicateMarker) {
