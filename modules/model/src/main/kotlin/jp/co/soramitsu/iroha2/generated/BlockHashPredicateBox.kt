...
public sealed class BlockHashPredicateBox : ModelEnum {
     ...
     * 'Equals' variant
     */
    public data class Equals(public val hashOf: HashOf<BlockHeader>) : BlockHashPredicateBox() {
        ...
        public companion object :
            ...
            override fun write(writer: ScaleCodecWriter, instance: jp.co.soramitsu.iroha2.generated.BlockHashPredicateBox.Equals): Unit =
                try {
    ...
    public companion object : ScaleReader<BlockHashPredicateBox>, ScaleWriter<BlockHashPredicateBox> {
        override fun read(reader: ScaleCodecReader): BlockHashPredicateBox = when (val discriminant = reader.readUByte()) {
