 ...
 */
public data class MetadataKeyProjectionOfPredicateMarker(public val key: Name, public val projection: JsonProjectionOfPredicateMarker) {
    public companion object :
        ScaleReader<MetadataKeyProjectionOfPredicateMarker>,
        ScaleWriter<MetadataKeyProjectionOfPredicateMarker> {
        override fun read(reader: ScaleCodecReader): MetadataKeyProjectionOfPredicateMarker = try {
            MetadataKeyProjectionOfPredicateMarker(
                Name.read(reader),
        ...
        override fun write(writer: ScaleCodecWriter, instance: MetadataKeyProjectionOfPredicateMarker): Unit = try {
