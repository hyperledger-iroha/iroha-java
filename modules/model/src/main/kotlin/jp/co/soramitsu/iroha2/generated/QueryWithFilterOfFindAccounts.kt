...
public data class QueryWithFilterOfFindAccounts(
    ...
    public companion object :
        ...
        override fun read(reader: ScaleCodecReader): QueryWithFilterOfFindAccounts = try {
            QueryWithFilterOfFindAccounts(
        ...
        override fun write(writer: ScaleCodecWriter, instance: QueryWithFilterOfFindAccounts): Unit = try {
