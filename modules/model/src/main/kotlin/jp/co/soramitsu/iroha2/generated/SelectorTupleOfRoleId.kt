 ...
 */
public data class SelectorTupleOfRoleId(
    public val vecOfRoleIdProjectionOfSelectorMarker: List<RoleIdProjectionOfSelectorMarker>,
) {
    public companion object : ScaleReader<SelectorTupleOfRoleId>, ScaleWriter<SelectorTupleOfRoleId> {
        override fun read(reader: ScaleCodecReader): SelectorTupleOfRoleId =
            try {
                SelectorTupleOfRoleId(
