...
public sealed class SignedTransactionProjectionOfSelectorMarker : ModelEnum {
    ...
    public class Atom : SignedTransactionProjectionOfSelectorMarker() {
        ...
        public companion object :
            ...
            public fun equals(
                o1: jp.co.soramitsu.iroha2.generated.SignedTransactionProjectionOfSelectorMarker.Atom,
                o2: Any?,
            ): Boolean =
                when (o2) {
                    null -> false
    ...
    public data class Hash(
        public val transactionHashProjectionOfSelectorMarker: TransactionHashProjectionOfSelectorMarker,
    ) : SignedTransactionProjectionOfSelectorMarker() {
        override fun discriminant(): Int = DISCRIMINANT
    ...
    public data class Authority(
        ...
        public companion object :
            ...
            ): jp.co.soramitsu.iroha2.generated.SignedTransactionProjectionOfSelectorMarker.Authority =
                try {
                    Authority(
    ...
    public companion object :
        ...
        override fun write(
            writer: ScaleCodecWriter,
            instance: SignedTransactionProjectionOfSelectorMarker,
        ) {
