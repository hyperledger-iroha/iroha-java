 ...
 */
fun resolveScaleReadImpl(type: Type): CodeBlock = when (type) {
 ...
 */
fun resolveScaleWriteImpl(type: Type, propName: CodeBlock): CodeBlock = when (type) {
 ...
 */
fun withoutGenerics(typeName: TypeName): ClassName = when (typeName) {
...
private fun ArrayType.scaleReadImpl(): CodeBlock = when (this.innerType.requireValue()) {
...
private fun VecType.scaleReadImpl(): CodeBlock = when (this.innerType.requireValue()) {
...
private fun OptionType.scaleReadImpl(): CodeBlock = when (this.innerType.requireValue()) {
...
private fun CompactType.scaleReadImpl(): CodeBlock = when (val innerType = this.innerType.requireValue()) {
...
private fun OptionType.scaleWriteImpl(propName: CodeBlock): CodeBlock = when (this.innerType.requireValue()) {
...
private fun ArrayType.scaleWriteImpl(propName: CodeBlock): CodeBlock = when (this.innerType.requireValue()) {
...
private fun VecType.scaleWriteImpl(propName: CodeBlock): CodeBlock = when (this.innerType.requireValue()) {
